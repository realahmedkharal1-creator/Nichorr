  ...
  return (
    <div className="relative mb-6 border-b border-slate-200 group flex items-center">
      ...
      <button 
        ...
        className="absolute left-0 z-20 p-1 bg-gradient-to-r from-white via-white/90 to-transparent h-full flex items-center opacity-0 group-hover:opacity-100 transition-opacity"
      >
      ...
      <button 
        ...
        className="absolute right-0 z-20 p-1 bg-gradient-to-l from-white via-white/90 to-transparent h-full flex items-center opacity-0 group-hover:opacity-100 transition-opacity"
      >
        <div className="bg-white border border-slate-200 shadow-sm rounded-full p-1 text-slate-500 hover:text-slate-900 hover:bg-slate-50 cursor-pointer">
