...
export async function GET(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    return NextResponse.json({
      ...
      dimensions: distPackage.readinessReport.dimensions,
      blockers: distPackage.readinessReport.blockingReasons,
      blockerExplanations: distPackage.readinessReport.blockerExplanations,
    });
  } catch (error: any) {
