...
export default function CreatorWorkspacePage({ params }: { params: { id: string } }) {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="slate-card p-12 text-center space-y-3">
          ...
          <h3 className="text-base font-bold text-slate-200">No Creator Studio Data Available</h3>
          <p className="text-xs text-slate-400">Unable to generate script intelligence for this research run.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="bg-slate-950 border border-slate-800/80 rounded-2xl p-3 sm:p-4 shadow-sm">
        <div className="flex items-center justify-between overflow-x-auto gap-2 text-xs font-mono">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-teal-400 font-bold hover:underline"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-purple-400 font-bold hover:underline"
          >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="flex items-center gap-1 bg-slate-900 border border-slate-800 p-1 rounded-xl">
              <span className="text-xs text-slate-400 font-mono ml-2 mr-1">Mode:</span>
              <button
            ...
            <div className="flex items-center gap-1 bg-slate-900 border border-slate-800 p-1 rounded-xl">
              ...
              <span className="text-xs text-slate-400 font-mono mr-1">Duration:</span>
            ...
            {preferences.enableTeleprompter && preferences.generateScript ? (
              <button
                ...
                className="flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white px-4 py-2 rounded-xl text-xs font-semibold shadow-sm transition"
              >
      ...
      <div className="flex gap-2 border-b border-slate-800 pb-2 overflow-x-auto">
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "project"
              ...
              : "bg-slate-900 text-indigo-300 border-indigo-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "matrix"
              ...
              : "bg-slate-900 text-teal-300 border-teal-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "exportWorkspace"
              ...
              : "bg-slate-900 text-blue-300 border-blue-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "publishingOrchestrator"
              ...
              : "bg-slate-900 text-violet-300 border-violet-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "publicationIntegrity"
              ...
              : "bg-slate-900 text-rose-300 border-rose-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "researchCalibration"
              ...
              : "bg-slate-900 text-amber-300 border-amber-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "siliconRegression"
              ...
              : "bg-slate-900 text-cyan-300 border-cyan-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "testbenchControl"
              ...
              : "bg-slate-900 text-emerald-300 border-emerald-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "crossLabRegression"
              ...
              : "bg-slate-900 text-sky-300 border-sky-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "coDesign"
              ...
              : "bg-slate-900 text-fuchsia-300 border-fuchsia-900/50 hover:bg-slate-855"
          }`}
        >
          <Cpu className="w-3.5 h-3.5 inline mr-1.5" />
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "performance"
              ...
              : "bg-slate-900 text-purple-300 border-purple-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition ${
            activeTab === "outline" ? "bg-indigo-600 text-white" : "bg-slate-900 text-slate-400 hover:text-slate-200"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "narration"
              ? "bg-emerald-600 text-white border-emerald-500 shadow-sm"
              : "bg-slate-900 text-emerald-400 border-emerald-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "quality"
              ? "bg-amber-600 text-white border-amber-500 shadow-sm"
              : "bg-slate-900 text-amber-400 border-amber-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "timeline"
              ? "bg-cyan-600 text-white border-cyan-500 shadow-sm"
              : "bg-slate-900 text-cyan-400 border-cyan-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "training"
              ? "bg-purple-600 text-white border-purple-500 shadow-sm"
              : "bg-slate-900 text-purple-400 border-purple-900/50 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition border ${
            activeTab === "controls"
              ? "bg-indigo-600 text-white border-indigo-500 shadow-sm"
              : "bg-slate-900 text-slate-300 border-slate-700 hover:bg-slate-855"
          }`}
        >
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-xl text-xs font-semibold whitespace-nowrap transition ${
            activeTab === "export" ? "bg-indigo-600 text-white" : "bg-slate-900 text-slate-400 hover:text-slate-200"
          }`}
        >
          <FileText className="w-3.5 h-3.5 inline mr-1.5" />
          Export Markdown
      ...
      {activeTab === "project" && (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 px-3 py-2 rounded-xl text-xs font-bold transition font-mono"
                >
          ...
          {projectOverview?.healthReport.blockers && projectOverview.healthReport.blockers.length > 0 && (
            <div className="p-5 rounded-2xl bg-rose-950/40 border border-rose-800/80 space-y-3 shadow-sm">
              ...
              <div className="space-y-2">
                {projectOverview.healthReport.blockers.map((blk) => (
                  <div
                    key={blk.blockerId}
                    className="p-3 rounded-xl bg-slate-950/80 border border-rose-900/60 flex items-start justify-between gap-3 text-xs font-mono"
                  >
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-slate-200">{blk.affectedNodeLabel}</span>
                      </div>
                      <p className="text-slate-300 font-sans text-xs">{blk.reason}</p>
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-slate-900 hover:bg-slate-800 text-rose-300 text-[11px] font-mono border border-rose-900/60 shrink-0 transition"
                    >
                      Why is this blocked?
                    </button>
                  </div>
          ...
          <div className="grid sm:grid-cols-5 gap-3">
            <div className="slate-card p-4 bg-slate-900/90 border-slate-800 space-y-1">
              <span className="text-[10px] font-mono text-teal-400 font-bold uppercase">1. RESEARCH HEALTH</span>
            ...
            <div className="slate-card p-4 bg-slate-900/90 border-slate-800 space-y-1">
              <span className="text-[10px] font-mono text-emerald-400 font-bold uppercase">2. CONTENT QUALITY</span>
            ...
            <div className="slate-card p-4 bg-slate-900/90 border-slate-800 space-y-1">
              <span className="text-[10px] font-mono text-indigo-400 font-bold uppercase">3. PRODUCTION READINESS</span>
            ...
            <div className="slate-card p-4 bg-slate-900/90 border-slate-800 space-y-1">
              <span className="text-[10px] font-mono text-purple-400 font-bold uppercase">4. PUBLISHING PREFLIGHT</span>
            ...
            <div className="slate-card p-4 bg-slate-900/90 border-slate-800 space-y-1">
              <span className="text-[10px] font-mono text-rose-400 font-bold uppercase">5. DISTRIBUTION STAGING</span>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              {projectOverview?.pipelineStages.map((stg) => (
                <div
                  key={stg.stageId}
                  className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-2 flex flex-col justify-between"
                >
                  <div className="space-y-1">
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`px-2 py-0.5 rounded text-[10px] font-mono font-bold ${
                        stg.status === 'READY' || stg.status === 'COMPLETED' ? 'bg-emerald-950 text-emerald-300 border border-emerald-800' :
                        stg.status === 'BLOCKED' ? 'bg-rose-950 text-rose-300 border border-rose-800' :
                    ...
                    {stg.score !== undefined && (
                      <p className="text-[11px] font-mono text-slate-400">Score: {stg.score}%</p>
                    )}
                    {stg.requiredAction && (
                      <p className="text-[11px] font-mono text-rose-400">{stg.requiredAction}</p>
                    )}
                  </div>

                  <button
                    onClick={() => setActiveTab(stg.targetTab as any)}
                    className="w-full py-1.5 rounded-lg bg-slate-900 hover:bg-slate-800 text-indigo-400 text-xs font-mono transition mt-2"
                  >
                    Open Subsystem →
                  </button>
                </div>
              ...
              <table className="w-full text-xs font-mono text-left text-slate-300">
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {projectOverview?.assets.map((asset) => (
                    <tr key={asset.assetId} className="hover:bg-slate-855/40">
                      <td className="p-2.5 font-bold text-slate-100">{asset.label}</td>
                      <td className="p-2.5 text-slate-400">{asset.assetType}</td>
                      <td className="p-2.5 text-indigo-400">{asset.subsystem}</td>
                      <td className="p-2.5">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                          asset.status === 'READY' || asset.status === 'HEALTHY' ? 'bg-emerald-950 text-emerald-300 border border-emerald-800' :
                          asset.status === 'BLOCKED' ? 'bg-rose-950 text-rose-300 border border-rose-800' :
                          'bg-amber-950 text-amber-300 border border-amber-800'
                        }`}>
                          {asset.status}
                        </span>
                      </td>
                      <td className="p-2.5 text-slate-400">v{asset.currentVersion}</td>
                      <td className="p-2.5">
                        <button
                          onClick={() => {
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              <div className="space-y-1">
                <label className="text-[10px] font-mono text-slate-400 uppercase font-bold">Select Upstream Claim / Node</label>
                <select
                  value={simulationTargetId}
                  onChange={(e) => setSimulationTargetId(e.target.value)}
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl p-2.5 text-xs text-slate-200 focus:outline-none focus:border-indigo-600"
                >
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-mono text-slate-400 uppercase font-bold">Simulated Change Action</label>
                <select
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full py-2.5 rounded-xl bg-amber-600 hover:bg-amber-500 disabled:opacity-50 text-white text-xs font-bold shadow-sm transition font-mono flex items-center justify-center gap-2"
                >
              ...
              <div className="p-4 rounded-xl bg-slate-950 border border-amber-900/60 space-y-3">
                <div className="flex items-center justify-between border-b border-slate-800/80 pb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-slate-200">{simulationPreview.targetNodeLabel}</span>
                  </div>
                ...
                <p className="text-xs text-slate-300 font-sans leading-relaxed">{simulationPreview.summary}</p>

                {simulationPreview.expectedConsequences.length > 0 && (
                  <div className="space-y-1">
                    <span className="text-[10px] font-mono text-amber-400 uppercase font-bold">DOWNSTREAM CONSEQUENCES</span>
                    <ul className="list-disc list-inside text-xs text-slate-300 font-sans space-y-1">
          ...
          {inspectedProjectNode && (
            <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
              <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-2xl w-full p-6 space-y-5 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    <Network className="w-5 h-5 text-indigo-400" />
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5 font-mono text-xs">
                  <div className="flex justify-between text-slate-400">
                    <span>NODE ID:</span>
                    <span className="font-bold text-slate-100">{inspectedProjectNode.id}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>TYPE:</span>
                    <span className="text-indigo-400 font-bold">{inspectedProjectNode.type}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>SUBSYSTEM:</span>
                    <span className="text-purple-400 font-bold">{inspectedProjectNode.subsystem}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>STATUS:</span>
                    <span className="text-emerald-400 font-bold">{inspectedProjectNode.status}</span>
                  </div>
                </div>

                <div className="grid sm:grid-cols-2 gap-3 font-mono text-xs">
                  <div className="p-3 rounded-lg bg-slate-950 border border-slate-855 space-y-1">
                    <span className="text-[10px] text-teal-400 uppercase font-bold block">UPSTREAM DEPENDENCIES ({inspectedProjectNode.upstreamNodeIds.length})</span>
                    {inspectedProjectNode.upstreamNodeIds.length === 0 ? (
                      ...
                      inspectedProjectNode.upstreamNodeIds.map((id) => (
                        <div key={id} className="text-slate-300 text-[11px] truncate">
                          • {id}
                        </div>
                      ))
                    )}
                  ...
                  <div className="p-3 rounded-lg bg-slate-950 border border-slate-855 space-y-1">
                    <span className="text-[10px] text-purple-400 uppercase font-bold block">DOWNSTREAM DEPENDENTS ({inspectedProjectNode.downstreamNodeIds.length})</span>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-2xl w-full p-6 space-y-5 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-bold text-slate-100">Project Blocker Intelligence</h3>
                  </div>
                  <button
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-rose-900/60 space-y-1.5 font-mono text-xs">
                  <div className="flex justify-between text-slate-400">
                    <span>AFFECTED SUBSYSTEM:</span>
                    <span className="font-bold text-rose-300">{inspectedProjectBlocker.subsystem}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>AFFECTED NODE:</span>
                    <span className="text-slate-100 font-bold">{inspectedProjectBlocker.affectedNodeLabel}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>SEVERITY:</span>
                    <span className="text-rose-400 font-bold">{inspectedProjectBlocker.severity}</span>
                  </div>
                </div>

                <div className="space-y-2 text-xs font-sans">
                  <span className="text-[10px] font-mono text-indigo-400 uppercase font-bold">ROOT CAUSE & REMEDIATION</span>
                  <div className="bg-slate-950 p-3.5 rounded-lg border border-slate-855 space-y-2 text-slate-300 leading-relaxed">
                    ...
                    <p className="text-[11px] font-mono text-amber-400 border-t border-slate-855 pt-2">
      ...
      {activeTab === "execution" && (
        <div className="space-y-6">
          {/* Notifications */}
          {executionSuccessMsg && (
            <div className="p-4 rounded-xl bg-emerald-950/60 border border-emerald-600/80 text-emerald-300 text-xs font-mono flex items-center gap-2">
          ...
          {executionErrorMsg && (
            <div className="p-4 rounded-xl bg-rose-950/60 border border-rose-600/80 text-rose-300 text-xs font-mono flex items-center gap-2">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <button
                  ...
                  disabled={isPlanning}
                  className="flex items-center gap-1.5 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white px-3.5 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-5 gap-2 text-center text-xs font-mono">
              <div className={`p-2.5 rounded-xl border ${
                executionPlan ? "bg-emerald-950/40 border-emerald-600 text-emerald-300 font-bold" : "bg-slate-950 border-slate-800 text-slate-500"
              }`}>
                <span>1. PLAN</span>
              </div>
              <div className={`p-2.5 rounded-xl border ${
                executionPlan?.executionStatus === 'APPROVED' || executionPlan?.executionStatus === 'STAGED' || executionPlan?.executionStatus === 'VALIDATED' || executionPlan?.executionStatus === 'COMMITTED'
                  ? "bg-indigo-950/40 border-indigo-600 text-indigo-300 font-bold"
              ...
              <div className={`p-2.5 rounded-xl border ${
                executionPlan?.executionStatus === 'STAGED' || executionPlan?.executionStatus === 'VALIDATED' || executionPlan?.executionStatus === 'COMMITTED'
                  ? "bg-cyan-950/40 border-cyan-600 text-cyan-300 font-bold"
                  : "bg-slate-950 border-slate-800 text-slate-500"
              }`}>
                <span>3. STAGE</span>
              </div>
              <div className={`p-2.5 rounded-xl border ${
                executionPlan?.executionStatus === 'VALIDATED' || executionPlan?.executionStatus === 'COMMITTED'
                  ? "bg-teal-950/40 border-teal-600 text-teal-300 font-bold"
                  : "bg-slate-950 border-slate-800 text-slate-500"
              }`}>
          ...
          {executionPlan && (
            <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 flex flex-wrap items-center justify-between gap-3">
              <div className="flex items-center gap-2 text-xs font-mono text-slate-300">
                <span className="font-bold text-slate-100">Plan:</span>
                <span>{executionPlan.executionPlanId.slice(0, 24)}...</span>
                <span className="text-slate-500">•</span>
                <span className="text-indigo-400">Trigger: {executionPlan.triggerType}</span>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                {executionPlan.executionStatus === 'PLANNED' && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white text-xs font-bold font-mono shadow-sm transition"
                  >
                ...
                {executionPlan.executionStatus === 'APPROVED' && (
                  <button
                    ...
                    disabled={isStaging}
                    className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-cyan-600 hover:bg-cyan-500 disabled:opacity-50 text-white text-xs font-bold font-mono shadow-sm transition"
                  >
                ...
                {executionPlan.executionStatus === 'VALIDATED' && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold font-mono shadow-sm transition"
                  >
                ...
                {(executionPlan.executionStatus === 'STAGED' || executionPlan.executionStatus === 'VALIDATION_FAILED') && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-rose-950 hover:bg-rose-900 border border-rose-800 text-rose-300 text-xs font-bold font-mono transition"
                  >
          ...
          {executionPlan && (
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
                <span className="text-[10px] font-mono text-emerald-400 font-bold uppercase block">WILL CHANGE</span>
                <span className="text-xl font-extrabold text-slate-100">{executionPlan.expectedImpact.willChangeCount}</span>
                <span className="text-[11px] text-slate-500 block">Proposed operations</span>
              </div>

              <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
                <span className="text-[10px] font-mono text-amber-400 font-bold uppercase block">MAY CHANGE</span>
                <span className="text-xl font-extrabold text-slate-100">{executionPlan.expectedImpact.mayChangeCount}</span>
                <span className="text-[11px] text-slate-500 block">Downstream candidates</span>
              </div>

              <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
                <span className="text-[10px] font-mono text-slate-400 font-bold uppercase block">UNCHANGED</span>
                <span className="text-xl font-extrabold text-slate-100">{executionPlan.expectedImpact.unchangedCount}</span>
                <span className="text-[11px] text-slate-500 block">Minimal change guarantee</span>
              </div>

              <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
                <span className="text-[10px] font-mono text-rose-400 font-bold uppercase block">HARD BLOCKERS</span>
                <span className="text-xl font-extrabold text-slate-100">{executionPlan.expectedImpact.blockedCount}</span>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {executionPlan.proposedOperations.map((op) => (
                      <tr key={op.id} className="hover:bg-slate-855/40">
                        <td className="p-2.5">
                          <input
                            type="checkbox"
                        ...
                        <td className="p-2.5 font-bold text-slate-200">{op.operationType}</td>
                        <td className="p-2.5 text-slate-300 font-sans">{op.targetLabel}</td>
                        <td className="p-2.5 text-indigo-400">{op.subsystem}</td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                            op.status === 'APPROVED' ? 'bg-emerald-950 text-emerald-300 border border-emerald-800' :
                            op.status === 'REJECTED' ? 'bg-rose-950 text-rose-300 border border-rose-800' :
          ...
          {validationReport && (
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1 font-mono text-center">
                  <span className="text-[10px] text-teal-400 uppercase font-bold block">1. HEALTH</span>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1 font-mono text-center">
                  <span className="text-[10px] text-emerald-400 uppercase font-bold block">2. QUALITY</span>
                  <div className="text-sm font-bold text-slate-200">
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1 font-mono text-center">
                  <span className="text-[10px] text-cyan-400 uppercase font-bold block">3. PRODUCTION</span>
                  <div className="text-sm font-bold text-slate-200">
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1 font-mono text-center">
                  <span className="text-[10px] text-purple-400 uppercase font-bold block">4. PUBLISHING</span>
                  <div className="text-sm font-bold text-slate-200">
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1 font-mono text-center">
                  <span className="text-[10px] text-rose-400 uppercase font-bold block">5. DISTRIBUTION</span>
                  <div className="text-sm font-bold text-slate-200">
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {executionHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-indigo-300">{ev.action}</td>
                        <td className="p-2.5 text-slate-300">v{ev.previousScriptVersion} → v{ev.newScriptVersion}</td>
                        <td className="p-2.5 text-slate-300 font-sans">{ev.executionResult}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-2xl w-full p-6 space-y-5 shadow-2xl animate-in fade-in zoom-in duration-150">
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5 font-mono text-xs">
                  <div className="flex justify-between text-slate-400">
                    ...
                    <span className="font-bold text-slate-100">{inspectedOp.id}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>OPERATION TYPE:</span>
                    <span className="text-emerald-400 font-bold">{inspectedOp.operationType}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>SUBSYSTEM:</span>
                    <span className="text-indigo-400 font-bold">{inspectedOp.subsystem}</span>
                  </div>
                </div>

                <div className="space-y-2 text-xs font-sans">
                  <span className="text-[10px] font-mono text-indigo-400 uppercase font-bold">REASON & UPSTREAM EVIDENCE</span>
                  <div className="bg-slate-950 p-3.5 rounded-lg border border-slate-855 space-y-2 text-slate-300 leading-relaxed">
          ...
          {showCommitModal && (
            <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
              <div className="bg-slate-900 border border-emerald-800/80 rounded-2xl max-w-lg w-full p-6 space-y-5 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-5 h-5 text-emerald-400" />
                    <h3 className="text-sm font-bold text-slate-100">Commit Staged Version to Active Project</h3>
                  </div>
                  <button
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5 font-mono text-xs text-slate-300">
                  <div className="flex justify-between">
                    <span>Target Script Version:</span>
                    <span className="font-bold text-emerald-400">v{(report.scriptVersion || 1) + 1}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Validation Status:</span>
                    <span className="font-bold text-teal-400">PASSED</span>
                  </div>
                </div>
                ...
                <div className="flex justify-end gap-2 pt-2 border-t border-slate-800">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white text-xs font-mono font-bold transition"
                  >
          ...
          {showRollbackModal && (
            <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
              <div className="bg-slate-900 border border-rose-800/80 rounded-2xl max-w-lg w-full p-6 space-y-5 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    <Undo2 className="w-5 h-5 text-rose-400" />
                    <h3 className="text-sm font-bold text-slate-100">Rollback Staged Execution</h3>
                  </div>
                  <button
                ...
                <div className="flex justify-end gap-2 pt-2 border-t border-slate-800">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-rose-600 hover:bg-rose-500 disabled:opacity-50 text-white text-xs font-mono font-bold transition"
                  >
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  {certificate?.isReleaseLocked && (
                    <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold uppercase bg-amber-950 text-amber-300 border border-amber-700 flex items-center gap-1">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-amber-600 hover:bg-amber-500 disabled:opacity-50 text-white px-3.5 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
                ...
                {certificate && !certificate.isReleaseLocked && (
                  <button
                    ...
                    className="flex items-center gap-1.5 bg-emerald-700 hover:bg-emerald-600 disabled:opacity-40 text-white px-3.5 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                  >
                ...
                {certificate && certificate.isReleaseLocked && (
                  <button
                    ...
                    className="flex items-center gap-1.5 bg-rose-950 hover:bg-rose-900 border border-rose-800 text-rose-300 px-3.5 py-2 rounded-xl text-xs font-bold font-mono transition"
                  >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white px-3.5 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
                  <Package className="w-3.5 h-3.5" />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <span className="text-[10px] text-slate-500 uppercase block">PROJECT SNAPSHOT</span>
                <span className="text-slate-200 font-bold truncate block">{certificate?.projectSnapshotHash || "N/A"}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <span className="text-[10px] text-slate-500 uppercase block">EVIDENCE SNAPSHOT</span>
                <span className="text-teal-400 font-bold truncate block">{certificate?.evidenceSnapshotHash || "N/A"}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <span className="text-[10px] text-slate-500 uppercase block">SCRIPT VERSION</span>
                <span className="text-indigo-400 font-bold block">v{certificate?.scriptVersion || report.scriptVersion || 1}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <span className="text-[10px] text-slate-500 uppercase block">INTEGRITY SCORE</span>
                <span className="text-amber-400 font-bold block">{certificate?.overallIntegrityScore || 0}%</span>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono text-xs">
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] text-slate-400 uppercase font-bold">1. RESEARCH</span>
                    <span className={`text-[10px] font-bold ${certificate.dimensions.researchIntegrity.status === 'PASS' ? 'text-emerald-400' : 'text-rose-400'}`}>
                      {certificate.dimensions.researchIntegrity.status}
                    </span>
                  </div>
                  <div className="text-slate-200 font-bold">Score: {certificate.dimensions.researchIntegrity.score}%</div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] text-slate-400 uppercase font-bold">2. EVIDENCE</span>
                    <span className={`text-[10px] font-bold ${certificate.dimensions.evidenceIntegrity.status === 'PASS' ? 'text-emerald-400' : 'text-amber-400'}`}>
                      {certificate.dimensions.evidenceIntegrity.status}
                    </span>
                  </div>
                  <div className="text-slate-200 font-bold">Freshness: {certificate.dimensions.evidenceIntegrity.freshnessScore}%</div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] text-slate-400 uppercase font-bold">3. CLAIM SAFETY</span>
                    <span className={`text-[10px] font-bold ${certificate.dimensions.claimSafety.status === 'PASS' ? 'text-emerald-400' : 'text-rose-400'}`}>
                      {certificate.dimensions.claimSafety.status}
                    </span>
                  </div>
                  <div className="text-slate-200 font-bold">Verified: {certificate.dimensions.claimSafety.verifiedCount}</div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] text-slate-400 uppercase font-bold">4. SCRIPT</span>
                    <span className={`text-[10px] font-bold ${certificate.dimensions.scriptIntegrity.status === 'PASS' ? 'text-emerald-400' : 'text-amber-400'}`}>
                      {certificate.dimensions.scriptIntegrity.status}
                    </span>
                  </div>
                  <div className="text-slate-200 font-bold">Quality: {certificate.dimensions.scriptIntegrity.qualityScore}% ({certificate.dimensions.scriptIntegrity.qualityGrade})</div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] text-slate-400 uppercase font-bold">5. PRODUCTION</span>
                    <span className={`text-[10px] font-bold ${certificate.dimensions.productionIntegrity.status === 'PASS' ? 'text-emerald-400' : 'text-amber-400'}`}>
                      {certificate.dimensions.productionIntegrity.status}
                    </span>
                  </div>
                  <div className="text-slate-200 font-bold">Readiness: {certificate.dimensions.productionIntegrity.readinessScore}%</div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] text-slate-400 uppercase font-bold">6. PUBLISHING</span>
                    <span className={`text-[10px] font-bold ${certificate.dimensions.publishingIntegrity.status === 'PASS' ? 'text-emerald-400' : 'text-rose-400'}`}>
                      {certificate.dimensions.publishingIntegrity.status}
                    </span>
                  </div>
                  <div className="text-slate-200 font-bold">Score: {certificate.dimensions.publishingIntegrity.score}%</div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] text-slate-400 uppercase font-bold">7. DISTRIBUTION</span>
                    <span className={`text-[10px] font-bold ${certificate.dimensions.distributionIntegrity.status === 'PASS' ? 'text-emerald-400' : 'text-rose-400'}`}>
                      {certificate.dimensions.distributionIntegrity.status}
                    </span>
                  </div>
                  <div className="text-slate-200 font-bold">Readiness: {certificate.dimensions.distributionIntegrity.readinessScore}%</div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] text-slate-400 uppercase font-bold">8. EXECUTION</span>
                    <span className={`text-[10px] font-bold ${certificate.dimensions.executionIntegrity.status === 'PASS' ? 'text-emerald-400' : 'text-amber-400'}`}>
                      {certificate.dimensions.executionIntegrity.status}
                    </span>
                  </div>
                  <div className="text-slate-200 font-bold">Plan: {certificate.dimensions.executionIntegrity.latestPlanStatus}</div>
                  ...
                  <div key={blk.id} className="py-3 flex items-start justify-between gap-4">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-slate-200 font-sans">{blk.reason}</span>
                      </div>
                      <p className="text-xs text-slate-400 font-sans">Cause: {blk.upstreamCause}</p>
                      <p className="text-[11px] font-mono text-amber-400">Required: {blk.requiredAction}</p>
                    </div>
                    <button
                      onClick={() => setInspectedCertBlocker(blk)}
                      className="text-xs text-indigo-400 hover:text-indigo-300 shrink-0 font-mono"
                    >
                      Inspect Lineage
                    </button>
                  </div>
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {handoffManifest.includedAssets.map((asset, idx) => (
                      <tr key={idx} className="hover:bg-slate-855/40">
                        <td className="p-2.5 font-bold text-slate-200">{asset.name}</td>
                        <td className="p-2.5 text-indigo-300">{asset.type}</td>
                        <td className="p-2.5 text-slate-400">{asset.subsystem}</td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                            asset.available ? 'bg-emerald-950 text-emerald-300 border border-emerald-800' : 'bg-slate-950 text-slate-500'
                          }`}>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {certHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-amber-300">{ev.action}</td>
                        <td className="p-2.5 text-slate-300">v{ev.scriptVersion}</td>
                        <td className="p-2.5 text-slate-300 font-sans">{ev.details}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-2xl w-full p-6 space-y-5 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-bold text-slate-100">Certification Blocker Lineage Inspector</h3>
                  </div>
                  <button
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5 font-mono text-xs">
                  <div className="flex justify-between text-slate-400">
                    ...
                    <span className="font-bold text-slate-100">{inspectedCertBlocker.id}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>SUBSYSTEM:</span>
                    <span className="text-amber-400 font-bold">{inspectedCertBlocker.subsystem}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>AFFECTED NODE:</span>
                    <span className="text-indigo-400 font-bold">{inspectedCertBlocker.affectedNode}</span>
                  </div>
                </div>

                <div className="space-y-2 text-xs font-sans">
                  <span className="text-[10px] font-mono text-indigo-400 uppercase font-bold">REASON & UPSTREAM CAUSE</span>
                  <div className="bg-slate-950 p-3.5 rounded-lg border border-slate-855 space-y-2 text-slate-300 leading-relaxed">
          ...
          {showLockModal && certificate && (
            <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
              <div className="bg-slate-900 border border-amber-800/80 rounded-2xl max-w-lg w-full p-6 space-y-5 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    <Lock className="w-5 h-5 text-amber-400" />
                    <h3 className="text-sm font-bold text-slate-100">Apply Release Lock</h3>
                  </div>
                  <button
                ...
                <p className="text-xs text-slate-300 font-sans leading-relaxed">
                  You are locking Script Version {certificate.scriptVersion} and Project Snapshot Hash <code className="text-amber-400 font-mono">{certificate.projectSnapshotHash}</code> as the certified handoff/release state. Any mutation to claims, evidence, or script will invalidate this lock.
                </p>

                <div className="space-y-1">
                  <label className="text-[11px] font-mono text-slate-400 block">Release Notes (Optional):</label>
                  <input
                    type="text"
                    value={lockNotes}
                ...
                <div className="flex justify-end gap-2 pt-2 border-t border-slate-800">
                  ...
                  <button
                    ...
                    disabled={isLocking}
                    className="px-4 py-2 rounded-xl bg-amber-600 hover:bg-amber-500 disabled:opacity-50 text-white text-xs font-mono font-bold transition"
                  >
              ...
              <div className="bg-slate-900 border border-rose-800/80 rounded-2xl max-w-lg w-full p-6 space-y-5 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-bold text-slate-100">Unlock Certified Release State</h3>
                  </div>
                  <button
                ...
                <div className="space-y-1">
                  <label className="text-[11px] font-mono text-slate-400 block">Reason for Unlock (Optional):</label>
                  <input
                    type="text"
                    value={unlockReason}
                    onChange={(e) => setUnlockReason(e.target.value)}
                    placeholder="e.g., Updating benchmark numbers from latest retest."
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-xs text-slate-200 focus:outline-none focus:border-rose-500 font-sans"
                  />
                </div>
      ...
      {activeTab === "performance" && (
        <div className="space-y-6">
          {/* Notifications */}
          {perfSuccessMsg && (
            <div className="p-4 rounded-xl bg-purple-950/60 border border-purple-600/80 text-purple-300 text-xs font-mono flex items-center gap-2">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase bg-purple-950 text-purple-300 border border-purple-800">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-purple-600 hover:bg-purple-500 text-white px-3.5 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 px-3.5 py-2 rounded-xl text-xs font-bold font-mono transition"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-500 text-white px-3.5 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 font-mono text-xs">
              <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <div className="flex justify-between text-slate-500 text-[10px] uppercase">
                  <span>VIEWS</span>
                  <span className="text-emerald-400 font-bold">{perfSnapshot?.metrics.views?.availability || "AVAILABLE"}</span>
                </div>
              ...
              <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <div className="flex justify-between text-slate-500 text-[10px] uppercase">
                  <span>RETENTION</span>
                  <span className="text-emerald-400 font-bold">{perfSnapshot?.metrics.averagePercentageViewed?.availability || "AVAILABLE"}</span>
                </div>
              ...
              <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <div className="flex justify-between text-slate-500 text-[10px] uppercase">
                  <span>CTR</span>
                  <span className="text-emerald-400 font-bold">{perfSnapshot?.metrics.ctr?.availability || "AVAILABLE"}</span>
                </div>
              ...
              <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <div className="flex justify-between text-slate-500 text-[10px] uppercase">
                  ...
                  <span className="text-emerald-400 font-bold">{perfSnapshot?.metrics.watchTimeHours?.availability || "AVAILABLE"}</span>
                </div>
              ...
              <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <div className="flex justify-between text-slate-500 text-[10px] uppercase">
                  <span>LIKES</span>
                  <span className="text-emerald-400 font-bold">{perfSnapshot?.metrics.likes?.availability || "AVAILABLE"}</span>
                </div>
              ...
              <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <div className="flex justify-between text-slate-500 text-[10px] uppercase">
                  <span>COMMENTS</span>
                  <span className="text-emerald-400 font-bold">{perfSnapshot?.metrics.comments?.availability || "AVAILABLE"}</span>
                </div>
            ...
            {perfInsights.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {perfInsights.map((ins) => (
                  <div key={ins.insightId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2.5">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-slate-200 font-sans">{ins.category}</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-mono font-bold border ${
                        ins.confidence === 'HIGH_CONFIDENCE' ? 'bg-emerald-950 text-emerald-300 border-emerald-800' :
                        ins.confidence === 'MODERATE_CONFIDENCE' ? 'bg-indigo-950 text-indigo-300 border-indigo-800' :
                    ...
                    <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 space-y-1 text-xs text-slate-400 font-sans">
                      <p><strong>Recommended Action:</strong> {ins.recommendedAction}</p>
                      <p className="text-[11px] font-mono text-purple-400">Causality: {ins.causalityType} (Sample: {ins.sampleSize.toLocaleString()} views)</p>
                    </div>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {audienceSignals.map((sig) => (
                      <tr key={sig.signalId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 font-bold text-indigo-300">{sig.category}</td>
                        <td className="p-2.5 text-slate-300 font-sans max-w-xs truncate">{sig.rawText}</td>
                        <td className="p-2.5">
                        ...
                        <td className="p-2.5">
                          <button
                            ...
                            className="px-2.5 py-1 rounded bg-indigo-600 hover:bg-indigo-500 disabled:opacity-40 text-white text-[11px] font-bold transition"
                          >
            ...
            {experiments.length === 0 ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {experiments.map((exp) => (
                      <tr key={exp.experimentId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 font-bold text-purple-300">{exp.variable}</td>
                        <td className="p-2.5 text-slate-300 font-sans max-w-xs truncate">{exp.hypothesis}</td>
                        ...
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            exp.conclusionState === 'SUPPORTED' ? 'bg-emerald-950 text-emerald-300 border-emerald-800' :
                            exp.conclusionState === 'PROMISING' ? 'bg-indigo-950 text-indigo-300 border-indigo-800' :
                ...
                {researchOpportunities.map((opp) => (
                  <div key={opp.opportunityId} className="py-3 flex items-start justify-between gap-4 font-sans text-xs">
                    <div className="space-y-1">
                      ...
                      <p className="text-[11px] font-mono text-amber-400">Action: {opp.actionRequired}</p>
                    </div>
                    <span className="px-2.5 py-1 rounded text-xs font-mono font-bold bg-slate-950 text-slate-300 border border-slate-800 shrink-0">
                      {opp.status}
                    </span>
                  </div>
                ))}
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {perfHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-purple-300">{ev.action}</td>
                        <td className="p-2.5 text-slate-300 font-sans">{ev.details}</td>
                      </tr>
                    ))}
                  </tbody>
          ...
          {showRecordSnapshotModal && (
            <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
              <div className="bg-slate-900 border border-purple-800/80 rounded-2xl max-w-md w-full p-6 space-y-4 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    <BarChart3 className="w-5 h-5 text-purple-400" />
                    <h3 className="text-sm font-bold text-slate-100">Record Post-Release Performance</h3>
                  </div>
                  <button
                ...
                <div className="space-y-3 font-sans text-xs">
                  <div>
                    <label className="text-[11px] font-mono text-slate-400 block mb-1">Views:</label>
                    <input
                      type="number"
                      value={newViews}
                  ...
                  <div>
                    <label className="text-[11px] font-mono text-slate-400 block mb-1">Average % Viewed (Retention):</label>
                    <input
                      type="number"
                      value={newRetention}
                  ...
                  <div>
                    <label className="text-[11px] font-mono text-slate-400 block mb-1">Click-Through Rate (CTR %):</label>
                    <input
                      type="number"
                      step="0.1"
                      value={newCtr}
                ...
                <div className="flex justify-end gap-2 pt-2 border-t border-slate-800">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 disabled:opacity-50 text-white text-xs font-mono font-bold transition"
                  >
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-6 space-y-4 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-bold text-slate-100">Log Audience Comment / Inquiry</h3>
                  </div>
                  <button
                ...
                <div className="flex justify-end gap-2 pt-2 border-t border-slate-800">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-cyan-600 hover:bg-cyan-500 disabled:opacity-50 text-white text-xs font-mono font-bold transition"
                  >
          ...
          {showExperimentModal && (
            <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
              <div className="bg-slate-900 border border-indigo-800/80 rounded-2xl max-w-lg w-full p-6 space-y-4 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    <FlaskConical className="w-5 h-5 text-indigo-400" />
                    <h3 className="text-sm font-bold text-slate-100">Set Up Content A/B Experiment</h3>
                  </div>
                  <button
                ...
                <div className="space-y-3 font-sans text-xs">
                  <div>
                    <label className="text-[11px] font-mono text-slate-400 block mb-1">Hypothesis:</label>
                    <input
                      type="text"
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="text-[11px] font-mono text-slate-400 block mb-1">Control (A):</label>
                      <input
                        type="text"
                        value={newExpControl}
                    ...
                    <div>
                      <label className="text-[11px] font-mono text-slate-400 block mb-1">Variant (B):</label>
                      <input
                        type="text"
                        value={newExpVariant}
                ...
                <div className="flex justify-end gap-2 pt-2 border-t border-slate-800">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white text-xs font-mono font-bold transition"
                  >
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-2xl w-full p-6 space-y-5 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-sm font-bold text-slate-100">Performance Inference Inspector</h3>
                  </div>
                  <button
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5 font-mono text-xs">
                  <div className="flex justify-between text-slate-400">
                    ...
                    <span className="font-bold text-slate-100">{inspectedInsight.insightId}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>CATEGORY:</span>
                    <span className="text-purple-400 font-bold">{inspectedInsight.category}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>CONFIDENCE:</span>
                    <span className="text-emerald-400 font-bold">{inspectedInsight.confidence}</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>CAUSALITY LEVEL:</span>
                    <span className="text-amber-400 font-bold">{inspectedInsight.causalityType}</span>
                  </div>
                </div>

                <div className="space-y-3 text-xs font-sans">
                  <div>
                    <span className="text-[10px] font-mono text-slate-400 uppercase font-bold block mb-1">OBSERVED SIGNAL</span>
                    <p className="bg-slate-950 p-3 rounded-lg border border-slate-855 text-slate-300 leading-relaxed">
                      {inspectedInsight.observedSignal}
                    </p>
                  </div>

                  <div>
                    <span className="text-[10px] font-mono text-indigo-400 uppercase font-bold block mb-1">ALTERNATIVE EXPLANATIONS</span>
                    <ul className="bg-slate-950 p-3 rounded-lg border border-slate-855 text-slate-300 space-y-1">
                  ...
                  <div>
                    <span className="text-[10px] font-mono text-emerald-400 uppercase font-bold block mb-1">RECOMMENDED ACTION</span>
                    <p className="bg-slate-950 p-3 rounded-lg border border-slate-855 text-emerald-300">
      ...
      {activeTab === "intelligence" && (
        <div className="space-y-6">
          {/* Notifications */}
          {intelSuccessMsg && (
            <div className="p-4 rounded-xl bg-cyan-950/60 border border-cyan-600/80 text-cyan-300 text-xs font-mono flex items-center gap-2">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-cyan-600 hover:bg-cyan-500 text-white px-3.5 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 font-mono text-xs">
              <div className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                <div className="flex justify-between items-center text-slate-400">
                  <span className="font-bold text-slate-200">YouTube Ingestion Adapter</span>
              ...
              <div className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                <div className="flex justify-between items-center text-slate-400">
                  <span className="font-bold text-slate-200">Podcast Ingestion Adapter</span>
              ...
              <div className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                <div className="flex justify-between items-center text-slate-400">
                  <span className="font-bold text-slate-200">Creator Manual Import</span>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            ...
            {!synthesisReport || synthesisReport.comparisonPairs.length === 0 ? (
              <div className="p-6 rounded-xl bg-slate-950 border border-slate-855 text-center space-y-2">
                <p className="text-xs font-mono text-slate-400">No benchmark synthesis generated yet.</p>
                <button
                  onClick={handleRunBenchmarkSynthesis}
                  disabled={isSynthesizing}
                  className="px-3.5 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-mono font-bold transition"
                >
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {synthesisReport.comparisonPairs.map((pair) => (
                      <tr key={pair.pairId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 font-bold text-slate-200">{pair.benchmarkA.benchmarkName}</td>
                        <td className="p-2.5 text-cyan-300">
                          <div>{pair.benchmarkA.entityName}</div>
                          <div className="text-[11px] text-slate-400 font-bold">{pair.benchmarkA.score} {pair.benchmarkA.metricUnit}</div>
                        </td>
                        <td className="p-2.5 text-purple-300">
                          <div>{pair.benchmarkB.entityName}</div>
                          <div className="text-[11px] text-slate-400 font-bold">{pair.benchmarkB.score} {pair.benchmarkB.metricUnit}</div>
                        </td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            pair.comparabilityState === "DIRECTLY_COMPARABLE" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            pair.comparabilityState === "COMPARABLE_WITH_CAVEATS" ? "bg-indigo-950 text-indigo-300 border-indigo-800" :
                            pair.comparabilityState === "PARTIALLY_COMPARABLE" ? "bg-amber-950 text-amber-300 border-amber-800" :
                            pair.comparabilityState === "CONFLICTED" ? "bg-rose-950 text-rose-300 border-rose-800" :
                            "bg-slate-950 text-slate-400 border-slate-800"
                          }`}>
                        ...
                        <td className="p-2.5">
                          <span className={`font-bold ${pair.scoreDeltaPercent >= 0 ? "text-emerald-400" : "text-rose-400"}`}>
                        ...
                        <td className="p-2.5 text-[11px] text-slate-400 font-sans">
                          {pair.methodologyDifferences.length > 0 ? (
                            ...
                            <span className="text-emerald-400 font-mono">Full alignment across presets & resolution</span>
                          )}
                        </td>
                      </tr>
                    ))}
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {ingestionSnapshots.map((snap) => (
                      <tr key={snap.snapshotId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 font-bold text-cyan-300">{snap.platform}</td>
                        <td className="p-2.5 text-slate-200">{snap.observations.length} items</td>
                        <td className="p-2.5">
                          <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-950 text-emerald-300 border border-emerald-800">
                            {snap.validationStatus}
                          </span>
                        </td>
                        <td className="p-2.5 text-slate-400">{snap.snapshotHash}</td>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {intelHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-cyan-300">{ev.action}</td>
                        <td className="p-2.5 text-slate-300 font-sans">{ev.details}</td>
                      </tr>
                    ))}
                  </tbody>
          ...
          {showImportModal && (
            <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
              <div className="bg-slate-900 border border-cyan-800/80 rounded-2xl max-w-md w-full p-6 space-y-4 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    <UploadCloud className="w-5 h-5 text-cyan-400" />
                    <h3 className="text-sm font-bold text-slate-100">Import Platform Ingestion Batch</h3>
                  </div>
                  <button
                ...
                <div className="space-y-3 font-sans text-xs">
                  <div>
                    <label className="text-[11px] font-mono text-slate-400 block mb-1">Platform Adapter:</label>
                    <select
                  ...
                  <div>
                    <label className="text-[11px] font-mono text-slate-400 block mb-1">Views / Downloads:</label>
                    <input
                      type="number"
                      value={importViews}
                  ...
                  <div>
                    <label className="text-[11px] font-mono text-slate-400 block mb-1">Average Retention (%):</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="text-[11px] font-mono text-slate-400 block mb-1">Click-Through Rate (%):</label>
                    <input
                      type="number"
                      step="0.1"
                      value={importCtr}
      ...
      {activeTab === "matrix" && (
        <div className="space-y-6">
          {/* Notifications */}
          {matrixSuccessMsg && (
            <div className="p-4 rounded-xl bg-teal-950/60 border border-teal-600/80 text-teal-300 text-xs font-mono flex items-center gap-2">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase bg-teal-950 text-teal-300 border border-teal-800">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-teal-600 hover:bg-teal-500 text-white px-3.5 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
                  <Plus className="w-3.5 h-3.5" />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">TOTAL VARIANTS</span>
                <span className="text-base font-bold text-slate-200">{productionMatrix?.totalVariantsCount || 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">ACTIVE VARIANTS</span>
                <span className="text-base font-bold text-teal-400">{productionMatrix?.activeVariantsCount || 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">READY FOR REVIEW</span>
                <span className="text-base font-bold text-emerald-400">{productionMatrix?.readyVariantsCount || 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">BLOCKED VARIANTS</span>
                <span className="text-base font-bold text-rose-400">{productionMatrix?.blockedVariantsCount || 0}</span>
              </div>
            </div>
          </div>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {productionMatrix.variants.map((v) => (
                      <tr
                        key={v.variantId}
                        className={`hover:bg-slate-855/40 cursor-pointer ${
                          selectedVariant?.variantId === v.variantId ? "bg-teal-950/30 border-l-2 border-teal-500" : ""
                        }`}
                      ...
                      >
                        ...
                        <td className="p-2.5 text-teal-300 font-bold">{v.variantType}</td>
                        <td className="p-2.5 text-slate-300">{v.targetDurationMinutes} min</td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            v.status === "APPROVED" || v.status === "CERTIFIED" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            v.status === "BLOCKED" ? "bg-rose-950 text-rose-300 border-rose-800" :
                            "bg-slate-950 text-slate-300 border-slate-800"
                          }`}>
                            {v.status}
                          </span>
                        </td>
                        <td className="p-2.5 text-slate-400">{v.evidenceBindings.length} verified</td>
                        <td className="p-2.5">
                          <span className={`font-bold ${v.readinessScore >= 80 ? "text-emerald-400" : "text-amber-400"}`}>
                            {v.readinessScore}%
                          </span>
                        </td>
                        <td className="p-2.5">
                          <button
                            ...
                            className="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-teal-300 text-[11px] font-mono transition"
                          >
                            Inspect
                          </button>
                        </td>
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              {benchmarkDiff ? (
                <div className="space-y-4 text-xs font-mono">
                  <div className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                    <div className="flex justify-between items-center text-slate-400">
                      <span className="font-bold text-slate-200">{benchmarkDiff.benchmarkName}</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                        benchmarkDiff.diffState === "IDENTICAL" ? "bg-slate-900 text-slate-300 border-slate-800" :
                        benchmarkDiff.diffState === "NUMERIC_CHANGE_ONLY" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                        benchmarkDiff.diffState === "METHODOLOGY_CHANGE" ? "bg-amber-950 text-amber-300 border-amber-800" :
                        "bg-indigo-950 text-indigo-300 border-indigo-800"
                      }`}>
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-855 text-[11px]">
                      <div>
                        <span className="text-slate-500 block">Baseline ({benchmarkDiff.baseline.hardwareIdentity}):</span>
                        <span className="text-slate-200 font-bold">{benchmarkDiff.baseline.score} {benchmarkDiff.baseline.metricUnit}</span>
                      </div>
                      <div>
                        <span className="text-slate-500 block">Candidate ({benchmarkDiff.candidate.hardwareIdentity}):</span>
                        <span className="text-teal-300 font-bold">{benchmarkDiff.candidate.score} {benchmarkDiff.candidate.metricUnit}</span>
                      </div>
                    </div>

                    <div className="flex justify-between items-center pt-2 border-t border-slate-855">
                      <span className="text-slate-400">Numerical Delta:</span>
                      <span className={`font-bold ${benchmarkDiff.percentageDelta >= 0 ? "text-emerald-400" : "text-rose-400"}`}>
                  ...
                  {benchmarkDiff.dimensionDifferences.length > 0 && (
                    <div className="space-y-1">
                      <span className="text-[10px] font-bold uppercase text-slate-400">Dimension Variations:</span>
                      <ul className="bg-slate-950 p-3 rounded-lg border border-slate-855 space-y-1 text-[11px] text-amber-300">
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1 font-sans text-xs">
                    <span className="text-[10px] font-mono font-bold uppercase text-slate-400 block">Recommended Action:</span>
                    <p className="text-slate-300">{benchmarkDiff.recommendedAction}</p>
                  </div>
                </div>
              ) : (
              ...
              {!assemblyPlan || assemblyPlan.assembledAssets.length === 0 ? (
                ...
                <div className="space-y-2">
                  {assemblyPlan.assembledAssets.map((ast) => (
                    <div key={ast.assetId} className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5 text-xs font-mono">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            ast.assemblyState === "AVAILABLE" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            ast.assemblyState === "BLOCKED" ? "bg-rose-950 text-rose-300 border-rose-800" :
                            ast.assemblyState === "STALE" ? "bg-amber-950 text-amber-300 border-amber-800" :
                            "bg-slate-900 text-slate-400 border-slate-800"
                          }`}>
                            {ast.assemblyState}
                          </span>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {matrixHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-teal-300">{ev.action}</td>
                        <td className="p-2.5 text-slate-300 font-sans">{ev.details}</td>
                      </tr>
                    ))}
                  </tbody>
          ...
          {showCreateVariantModal && (
            <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
              <div className="bg-slate-900 border border-teal-800/80 rounded-2xl max-w-md w-full p-6 space-y-4 shadow-2xl animate-in fade-in zoom-in duration-150">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  <div className="flex items-center gap-2">
                    <Layers className="w-5 h-5 text-teal-400" />
                    <h3 className="text-sm font-bold text-slate-100">Create Production Variant</h3>
                  </div>
                  <button
                ...
                <div className="space-y-3 font-sans text-xs">
                  <div>
                    <label className="text-[11px] font-mono text-slate-400 block mb-1">Variant Name:</label>
                    <input
                      type="text"
                      value={newVariantName}
                      onChange={(e) => setNewVariantName(e.target.value)}
                      placeholder="e.g. YouTube Short: GPU Power Efficiency"
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-slate-200 focus:outline-none focus:border-teal-500 font-sans"
                    />
                  </div>

                  <div>
                    <label className="text-[11px] font-mono text-slate-400 block mb-1">Variant Format:</label>
                    <select
                  ...
                  <div>
                    <label className="text-[11px] font-mono text-slate-400 block mb-1">Target Duration (Minutes):</label>
                    <input
                      type="number"
                ...
                <div className="flex justify-end gap-2 pt-2 border-t border-slate-800">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-teal-600 hover:bg-teal-500 disabled:opacity-50 text-white text-xs font-mono font-bold transition"
                  >
      ...
      {activeTab === "exportWorkspace" && (
        <div className="space-y-6">
          {/* Notifications */}
          {exportSuccessMsg && (
            <div className="p-4 rounded-xl bg-blue-950/60 border border-blue-600/80 text-blue-300 text-xs font-mono flex items-center gap-2">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className={`px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase border ${
                    exportPackage?.status === "EXPORTED" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                    exportPackage?.status === "READY" ? "bg-blue-950 text-blue-300 border-blue-800" :
                    exportPackage?.status === "BLOCKED" ? "bg-rose-950 text-rose-300 border-rose-800" :
                    "bg-slate-950 text-slate-300 border-slate-800"
                  }`}>
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 px-3.5 py-2 rounded-xl text-xs font-bold font-mono border border-slate-700 transition"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white px-4 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-slate-200 font-bold truncate block">{exportPackage?.certificationCertificateId || "CERT-VERIFIED"}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">EVIDENCE SNAPSHOT</span>
                <span className="text-blue-400 font-bold truncate block">{exportPackage?.evidenceSnapshotHash || "esnap-default"}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">PROJECT SNAPSHOT</span>
                <span className="text-teal-400 font-bold truncate block">{exportPackage?.projectSnapshotHash || "psnap-default"}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">SCRIPT VERSION</span>
                <span className="text-emerald-400 font-bold block">v{exportPackage?.scriptVersion || 1}</span>
              </div>
            </div>
          </div>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 font-mono text-xs">
              {exportPackage?.targets.map((t) => (
                <div key={t.targetFormat} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="font-bold text-slate-200">{t.displayName}</span>
                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                      t.status === "READY" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                      t.status === "READY_WITH_WARNINGS" ? "bg-amber-950 text-amber-300 border-amber-800" :
                      "bg-rose-950 text-rose-300 border-rose-800"
                    }`}>
                      {t.status}
                    </span>
                  ...
                  <div className="text-[11px] text-slate-400 space-y-1">
                    <div>Aspect Ratio: <span className="text-slate-200">{t.aspectRatio}</span></div>
                    {t.targetDurationMinutes && <div>Target Duration: <span className="text-slate-200">{t.targetDurationMinutes} min</span></div>}
                    <div>Required Assets: <span className="text-blue-300">{t.requiredAssetTypes.length} types</span></div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="space-y-2">
                {exportPackage?.assets.map((ast) => (
                  <div key={ast.assetId} className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1 text-xs font-mono">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-slate-200">{ast.name}</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                        ast.status === "AVAILABLE" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                        ast.status === "BLOCKED" ? "bg-rose-950 text-rose-300 border-rose-800" :
                        "bg-slate-900 text-slate-400 border-slate-800"
                      }`}>
                        {ast.status}
                      </span>
                    </div>
                    <div className="text-[11px] text-blue-300">{ast.expectedFilename} ({ast.mimeType})</div>
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="space-y-2">
                {exportPackage?.renderManifest?.entries.map((rme) => (
                  <div key={rme.entryId} className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1 text-xs font-mono">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-slate-200">{rme.expectedFilename}</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                        rme.renderCapabilityState === "AVAILABLE" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                        rme.renderCapabilityState === "BLOCKED" ? "bg-rose-950 text-rose-300 border-rose-800" :
                    ...
                    {rme.blockerReason && (
                      <div className="text-[10px] text-rose-400">Blocker: {rme.blockerReason}</div>
                    )}
                  </div>
                ))}
              </div>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              ...
              <span className={`px-2 py-0.5 rounded text-[10px] font-mono font-bold border ${
                exportPackage?.validationReport?.validationStatus === "PASS" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                exportPackage?.validationReport?.validationStatus === "WARNING" ? "bg-amber-950 text-amber-300 border-amber-800" :
                "bg-rose-950 text-rose-300 border-rose-800"
              }`}>
            ...
            {!exportPackage?.validationReport || exportPackage.validationReport.issues.length === 0 ? (
              <div className="p-4 rounded-xl bg-slate-950 border border-slate-855 text-center text-xs font-mono text-emerald-400">
                All 15 package validation dimensions passed with zero critical blockers.
              </div>
            ) : (
              <div className="space-y-2">
                {exportPackage.validationReport.issues.map((iss) => (
                  <div key={iss.issueId} className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1 text-xs font-mono">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-slate-200">{iss.category}</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                        iss.isBlocking ? "bg-rose-950 text-rose-300 border-rose-800" : "bg-amber-950 text-amber-300 border-amber-800"
                      }`}>
                        {iss.severity}
                      </span>
                    </div>
                    <div className="text-slate-300 font-sans">{iss.reason}</div>
                    <div className="text-[11px] text-blue-300">Action: {iss.requiredAction}</div>
                  </div>
                ))}
              </div>
            )}
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {exportHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-blue-300">{ev.action}</td>
                        <td className="p-2.5 text-slate-300 font-sans">{ev.details}</td>
                      </tr>
                    ))}
                  </tbody>
      ...
      {activeTab === "publishingOrchestrator" && (
        <div className="space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className={`px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase border ${
                    publishingPlan?.status === "PUBLISHED" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                    publishingPlan?.status === "PREFLIGHT_PASSED" || publishingPlan?.status === "APPROVED" ? "bg-violet-950 text-violet-300 border-violet-800" :
                    publishingPlan?.status === "PREFLIGHT_BLOCKED" ? "bg-rose-950 text-rose-300 border-rose-800" :
                    "bg-slate-950 text-slate-300 border-slate-800"
                  }`}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">CERTIFICATION BINDING</span>
                <span className="text-slate-200 font-bold truncate block">{publishingPlan?.certificationCertificateId || "CERT-VERIFIED"}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">EXPORT PACKAGE HASH</span>
                <span className="text-blue-400 font-bold truncate block">{publishingPlan?.exportPackageSnapshotHash || "pkg-snap-default"}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">EVIDENCE SNAPSHOT</span>
                <span className="text-teal-400 font-bold truncate block">{publishingPlan?.evidenceSnapshotHash || "esnap-default"}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">SCRIPT VERSION</span>
                <span className="text-emerald-400 font-bold block">v{publishingPlan?.scriptVersion || 1}</span>
              </div>
            </div>
          </div>
                ...
                <div
                  ...
                  className={`p-5 rounded-2xl border transition cursor-pointer space-y-4 ${
                    selectedPublishingTarget?.targetId === tgt.targetId
                      ? "bg-slate-900 border-violet-500 ring-1 ring-violet-500/40 shadow-sm"
                      : "bg-slate-900/80 border-slate-800 hover:border-slate-700"
                  }`}
                >
                  <div className="flex justify-between items-start">
                    <div>
                      <span className="text-xs font-bold text-slate-200 block">{tgt.platform}</span>
                      <span className="text-[10px] font-mono text-slate-400">Mode: {tgt.mode}</span>
                    </div>
                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold font-mono border ${
                      tgt.status === "PUBLISHED" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                      tgt.status === "APPROVED" || tgt.status === "PREFLIGHT_PASSED" ? "bg-violet-950 text-violet-300 border-violet-800" :
                      tgt.status === "STAGING_ONLY" ? "bg-blue-950 text-blue-300 border-blue-800" :
                      tgt.status === "PREFLIGHT_BLOCKED" ? "bg-rose-950 text-rose-300 border-rose-800" :
                      "bg-slate-950 text-slate-400 border-slate-800"
                    }`}>
                      {tgt.status}
                    </span>
                  ...
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5 text-xs font-mono">
                    <div className="flex justify-between text-[11px]">
                      <span className="text-slate-500">Connection:</span>
                      <span className="text-amber-400 font-bold">{tgt.connectionState}</span>
                    </div>
                    <div className="flex justify-between text-[11px]">
                      <span className="text-slate-500">Preflight:</span>
                      <span className={`font-bold ${tgt.preflightResult?.status === "PASS" ? "text-emerald-400" : tgt.preflightResult?.status === "PASS_WITH_WARNINGS" ? "text-amber-400" : "text-rose-400"}`}>
                        {tgt.preflightResult?.status || "PENDING"}
                      </span>
                    </div>
                    <div className="flex justify-between text-[11px]">
                      <span className="text-slate-500">Approval:</span>
                      <span className={`font-bold ${tgt.approvalState.isApproved ? "text-emerald-400" : "text-slate-400"}`}>
                    ...
                    {tgt.schedulingConfig?.isScheduled && (
                      <div className="flex justify-between text-[11px]">
                        ...
                        <span className="text-blue-300 truncate">{new Date(tgt.schedulingConfig.scheduledTimestamp).toLocaleTimeString()} ({tgt.schedulingConfig.timezoneIana})</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-800">
                    {!tgt.approvalState.isApproved && (
                      <button
                        ...
                        className="flex-1 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white text-xs font-mono font-bold transition"
                      >
                        Approve
                      </button>
                    )}
                    ...
                    {tgt.approvalState.isApproved && tgt.status !== "STAGED" && tgt.status !== "PUBLISHED" && tgt.status !== "STAGING_ONLY" && (
                      <button
                        ...
                        disabled={isPublishingLoading}
                        className="flex-1 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-xs font-mono font-bold transition"
                      >
                        Stage
                      </button>
                    )}
                    ...
                    {(tgt.status === "STAGED" || tgt.approvalState.isApproved) && tgt.status !== "PUBLISHED" && (
                      <button
                        ...
                        disabled={isPublishingLoading}
                        className="flex-1 py-1.5 rounded-lg bg-violet-600 hover:bg-violet-500 text-white text-xs font-mono font-bold transition"
                      >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  ...
                  <span className={`px-2 py-0.5 rounded text-[10px] font-mono font-bold border ${
                    selectedPublishingTarget.preflightResult?.status === "PASS" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                    selectedPublishingTarget.preflightResult?.status === "PASS_WITH_WARNINGS" ? "bg-amber-950 text-amber-300 border-amber-800" :
                    "bg-rose-950 text-rose-300 border-rose-800"
                  }`}>
                ...
                <div className="space-y-2 max-h-96 overflow-y-auto">
                  {selectedPublishingTarget.preflightResult?.checks.map((chk) => (
                    <div key={chk.checkId} className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1 text-xs font-mono">
                      <div className="flex justify-between items-center">
                        <span className="font-bold text-slate-200">{chk.name}</span>
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          chk.isBlocking ? "bg-rose-950 text-rose-300 border-rose-800" : "bg-amber-950 text-amber-300 border-amber-800"
                        }`}>
                          {chk.status}
                        </span>
                      </div>
                      <div className="text-slate-300 font-sans">{chk.reason}</div>
              ...
              <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
                ...
                <div className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-3 text-xs font-mono">
                  <div>
                    <span className="text-slate-500 block text-[10px]">TITLE</span>
                    <span className="text-slate-200 font-bold">{selectedPublishingTarget.metadata.title}</span>
                  </div>
                  <div>
                    <span className="text-slate-500 block text-[10px]">DESCRIPTION / SHOW NOTES</span>
                    <p className="text-slate-300 font-sans text-xs">{selectedPublishingTarget.metadata.description}</p>
                  </div>
                  ...
                  {selectedPublishingTarget.platform === "PODCAST" && (
                    <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 space-y-1">
                      <span className="text-slate-400 block text-[10px] font-bold">PODCAST AUDIO SPECIFICATION (REQ 24 AUDIT)</span>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {publishingReceipts.map((rec) => (
                      <tr key={rec.receiptId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(rec.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-violet-300">{rec.eventType}</td>
                        <td className="p-2.5 text-slate-300">{rec.platform}</td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            rec.status === "SUCCESS" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            rec.status === "STAGING_ONLY" ? "bg-blue-950 text-blue-300 border-blue-800" :
                            "bg-rose-950 text-rose-300 border-rose-800"
                          }`}>
                            {rec.status}
                          </span>
                        </td>
                        <td className="p-2.5 text-slate-300 font-sans truncate max-w-xs">{rec.details}</td>
          ...
          {verificationReport && (
            <div className="p-4 rounded-xl bg-slate-900 border border-slate-700 space-y-2 text-xs font-mono">
              <div className="flex justify-between items-center">
                <span className="font-bold text-slate-200">Post-Publish Verification Result</span>
                <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                  verificationReport.status === "VERIFIED" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                  "bg-slate-950 text-amber-300 border-amber-800"
                }`}>
                  {verificationReport.status}
                </span>
              </div>
              <p className="text-slate-300 font-sans">{verificationReport.notes}</p>
              <button
                onClick={() => setVerificationReport(null)}
                className="px-3 py-1 rounded bg-slate-800 text-slate-300 text-[10px]"
              >
                Dismiss
              </button>
            </div>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 max-w-md w-full space-y-4 shadow-xl">
                ...
                <div className="space-y-3 text-xs font-mono">
                  <div>
                    <label className="text-slate-400 block mb-1">Scheduled Release Date & Time:</label>
                    <input
                      type="datetime-local"
                      value={publishingScheduleTime}
                      onChange={(e) => setPublishingScheduleTime(e.target.value)}
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3 py-2 text-slate-200 focus:outline-none focus:border-violet-500 font-mono"
                    />
                  </div>

                  <div>
                    <label className="text-slate-400 block mb-1">Timezone (IANA):</label>
                    <select
                ...
                <div className="flex justify-end gap-2 pt-2 border-t border-slate-800">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-violet-600 hover:bg-violet-500 disabled:opacity-50 text-white text-xs font-mono font-bold transition"
                  >
                    Confirm Schedule
                  </button>
                </div>
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className={`px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase border ${
                    releaseHealthReport?.overallStatus === "PASS" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                    releaseHealthReport?.overallStatus === "WARNING" ? "bg-amber-950 text-amber-300 border-amber-800" :
                    releaseHealthReport?.overallStatus === "UNVERIFIABLE" ? "bg-slate-950 text-slate-300 border-slate-700" :
                    "bg-rose-950 text-rose-300 border-rose-800"
                  }`}>
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-rose-600 hover:bg-rose-500 disabled:opacity-50 text-white px-4 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-slate-200 font-bold block">{pubReconciliations.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">RECONCILED</span>
                <span className="text-emerald-400 font-bold block">{releaseHealthReport?.reconciledCount ?? 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">UNVERIFIABLE</span>
                <span className="text-amber-400 font-bold block">{releaseHealthReport?.unverifiableCount ?? 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">STALE</span>
                <span className="text-slate-400 font-bold block">{releaseHealthReport?.staleCount ?? 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">HARD BLOCKERS</span>
                <span className="text-rose-400 font-bold block">{releaseHealthReport?.activeBlockersCount ?? 0}</span>
              </div>
            </div>
          </div>
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 font-mono text-xs">
                {Object.values(releaseHealthReport.dimensions).map((dim) => (
                  <div key={dim.dimensionKey} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-slate-200 truncate">{dim.dimensionName}</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                        dim.status === "PASS" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                        dim.status === "WARNING" ? "bg-amber-950 text-amber-300 border-amber-800" :
                        dim.status === "NOT_CONFIGURED" || dim.status === "UNVERIFIABLE" ? "bg-slate-900 text-slate-400 border-slate-800" :
                        "bg-rose-950 text-rose-300 border-rose-800"
                      }`}>
                        {dim.status}
                      </span>
                    </div>
                    <p className="text-[11px] text-slate-400 font-sans line-clamp-2">{dim.details}</p>
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {pubReconciliations.map((pub) => (
                    <tr
                      ...
                      className={`hover:bg-slate-855/40 cursor-pointer ${
                        selectedPublication?.publicationId === pub.publicationId ? "bg-slate-855/60" : ""
                      }`}
                    >
                      <td className="p-2.5 font-bold text-slate-200">{pub.platform}</td>
                      <td className="p-2.5 text-slate-400 truncate max-w-xs">{pub.expectedState.publicationTarget}</td>
                      <td className="p-2.5">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          pub.reconciliationStatus === "MATCHED" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                          pub.reconciliationStatus === "CHANGED" ? "bg-amber-950 text-amber-300 border-amber-800" :
                          pub.reconciliationStatus === "UNVERIFIABLE" ? "bg-slate-950 text-slate-400 border-slate-800" :
                          "bg-rose-950 text-rose-300 border-rose-800"
                        }`}>
                          {pub.reconciliationStatus}
                        </span>
                      </td>
                      <td className="p-2.5 text-slate-300">{pub.receiptState}</td>
                      <td className="p-2.5">
                        <span className={pub.changes.length > 0 ? "text-amber-400 font-bold" : "text-slate-500"}>
                          {pub.changes.length} detected
                        </span>
                      </td>
                      <td className="p-2.5">
                        <span className={pub.blockers.length > 0 ? "text-rose-400 font-bold" : "text-emerald-400"}>
                ...
                {inspectedPubChanges.length === 0 ? (
                  ...
                  <div className="space-y-2 max-h-80 overflow-y-auto">
                    {inspectedPubChanges.map((chg) => (
                      <div key={chg.changeId} className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5 text-xs font-mono">
                        <div className="flex justify-between items-center">
                          <span className="font-bold text-slate-200">{chg.fieldName}</span>
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            chg.severity === "CRITICAL" ? "bg-rose-950 text-rose-300 border-rose-800" :
                            chg.severity === "WARNING" ? "bg-amber-950 text-amber-300 border-amber-800" :
                        ...
                        <div className="grid grid-cols-2 gap-2 text-[11px] bg-slate-900 p-2 rounded-lg">
                          <div>
                            ...
                            <span className="text-slate-300 truncate block">{String(chg.expectedValue)}</span>
                          </div>
                          <div>
                            <span className="text-slate-500 block text-[10px]">OBSERVED</span>
                            <span className="text-amber-300 truncate block">{String(chg.observedValue)}</span>
                          </div>
                        </div>
                        <div className="text-[11px] text-rose-300">Action: {chg.recommendedAction}</div>
                      </div>
                    ))}
                  </div>
                )}
                ...
                {inspectedPubLineage?.links ? (
                  <div className="space-y-1.5 max-h-80 overflow-y-auto font-mono text-xs">
                    {inspectedPubLineage.links.map((lnk, idx) => (
                      <div key={idx} className="p-2.5 rounded-xl bg-slate-950 border border-slate-855 flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2 truncate">
                          <span className="text-slate-500 text-[10px] w-6 shrink-0">{idx + 1}.</span>
                          <div>
                            <span className="font-bold text-slate-200 block text-[11px]">{lnk.stage}</span>
                            <span className="text-slate-400 text-[10px] font-sans truncate block">{lnk.summary}</span>
                          </div>
                        </div>
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border shrink-0 ${
                          lnk.status === "VALID" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                          lnk.status === "DRIFTED" ? "bg-amber-950 text-amber-300 border-amber-800" :
                          "bg-slate-900 text-slate-400 border-slate-800"
                        }`}>
                          {lnk.status}
                        </span>
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 font-mono text-xs">
                {unverifiableStates.map((unv, idx) => (
                  <div key={idx} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                    <span className="font-bold text-slate-200 block">{unv.platform}</span>
                    <p className="text-slate-400 font-sans text-[11px]">{unv.reason}</p>
                    <span className="text-[10px] text-amber-400 block font-bold">UNVERIFIABLE (NO ASSUMED SUCCESS)</span>
                  </div>
                ))}
              </div>
            </div>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {pubIntegrityHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-rose-300">{ev.eventType}</td>
                        <td className="p-2.5 text-slate-300">{ev.publicationId}</td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            ev.afterState === "MATCHED" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            ev.afterState === "CHANGED" ? "bg-amber-950 text-amber-300 border-amber-800" :
                            "bg-slate-950 text-slate-400 border-slate-800"
                          }`}>
                            {ev.afterState}
                          </span>
                        </td>
                        <td className="p-2.5 text-slate-300 font-sans truncate max-w-xs">{ev.reason}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
      ...
      {activeTab === "researchCalibration" && (
        <div className="space-y-6">
          ...
          {calibrationSuccessMsg && (
            <div className="p-4 rounded-xl bg-amber-950/60 border border-amber-600/80 text-amber-300 text-xs font-mono flex items-center gap-2">
          ...
          <div className="p-4 rounded-2xl bg-slate-950 border border-amber-800/60 text-amber-300 text-xs font-mono flex flex-col md:flex-row items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-2">
              <Scale className="w-4 h-4 text-amber-400 shrink-0" />
              <span className="font-bold">EVIDENCE BOUNDARY:</span>
              <span className="text-slate-300">Audience Signal ≠ Evidence &nbsp;|&nbsp; Performance ≠ Truth &nbsp;|&nbsp; Correlation ≠ Causation</span>
            </div>
            <span className="px-2.5 py-1 rounded bg-amber-950/80 text-amber-300 border border-amber-700/80 text-[10px] uppercase font-bold shrink-0">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase border bg-amber-950 text-amber-300 border-amber-800">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-amber-600 hover:bg-amber-500 disabled:opacity-50 text-white px-4 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-slate-200 font-bold block">{calibrationCandidates.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">QUEUED</span>
                <span className="text-amber-400 font-bold block">{calibrationQueue.filter((q) => q.status === "QUEUED").length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">VALIDATED</span>
                <span className="text-emerald-400 font-bold block">{calibrationQueue.filter((q) => q.status === "VALIDATED").length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">BLOCKED</span>
                <span className="text-rose-400 font-bold block">{calibrationQueue.filter((q) => q.status === "BLOCKED").length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">STALE</span>
                <span className="text-slate-400 font-bold block">{calibrationQueue.filter((q) => q.status === "STALE").length}</span>
              </div>
            </div>
          </div>
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {calibrationQueue.map((item) => (
                    <tr
                      ...
                      className={`hover:bg-slate-855/40 cursor-pointer ${
                        selectedCalibrationItem?.queueItemId === item.queueItemId ? "bg-slate-855/60" : ""
                      }`}
                    >
                      <td className="p-2.5">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          item.priority === "CRITICAL" ? "bg-rose-950 text-rose-300 border-rose-800" :
                          item.priority === "HIGH" ? "bg-amber-950 text-amber-300 border-amber-800" :
                          item.priority === "MEDIUM" ? "bg-blue-950 text-blue-300 border-blue-800" :
                          "bg-slate-950 text-slate-400 border-slate-800"
                        }`}>
                          {item.priority}
                        </span>
                      </td>
                      <td className="p-2.5 font-bold text-slate-200 truncate max-w-xs">{item.candidate.title}</td>
                      <td className="p-2.5 text-slate-400">{item.candidate.source}</td>
                      <td className="p-2.5 text-slate-300">{item.attribution.state}</td>
                      <td className="p-2.5 text-amber-300 font-bold">{item.evidenceImpact}</td>
                      <td className="p-2.5">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          item.status === "VALIDATED" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                          item.status === "BLOCKED" ? "bg-rose-950 text-rose-300 border-rose-800" :
                          item.status === "STALE" ? "bg-slate-950 text-slate-400 border-slate-800" :
                          "bg-amber-950 text-amber-300 border-amber-800"
                        }`}>
                          {item.status}
                        </span>
                      ...
                      <td className="p-2.5 text-right">
                        <button
                          ...
                          className="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 text-[10px] transition"
                        >
                          Inspect
                        </button>
                      </td>
              ...
              <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  ...
                  <span className={`px-2.5 py-1 rounded text-xs font-mono font-bold border ${
                    selectedCalibrationItem.attribution.state === "SUPPORTED_BY_MULTIPLE_SIGNALS" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                    selectedCalibrationItem.attribution.state === "CORRELATED" || selectedCalibrationItem.attribution.state === "POSSIBLE_CONTRIBUTOR" ? "bg-blue-950 text-blue-300 border-blue-800" :
                    "bg-amber-950 text-amber-300 border-amber-800"
                  }`}>
                ...
                <div className="space-y-3 text-xs font-mono">
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                    ...
                    <p className="text-slate-300 font-sans text-[11px]">{selectedCalibrationItem.attribution.observedRelationship}</p>
                  </div>

                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                      <span className="text-slate-500 block text-[10px]">SAMPLE SIZE</span>
                      <span className="text-slate-200 font-bold block">{selectedCalibrationItem.attribution.sampleSize} observations</span>
                    </div>
                    <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                      <span className="text-slate-500 block text-[10px]">CONFOUNDERS</span>
                      <span className="text-amber-400 font-bold block">{selectedCalibrationItem.attribution.confounders.length} detected</span>
                    </div>
                  </div>
                  ...
                  {selectedCalibrationItem.attribution.confidenceLimitations.length > 0 && (
                    <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                      ...
                      <ul className="list-disc pl-4 text-slate-400 font-sans text-[11px] space-y-0.5">
              ...
              <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
                ...
                <div className="space-y-3 text-xs font-mono">
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                    ...
                    <span className="text-amber-300 font-bold block">{selectedCalibrationItem.evidenceImpact}</span>
                    <p className="text-slate-400 font-sans text-[11px]">
                      {selectedCalibrationItem.candidate.priorityReason}
                    </p>
                  </div>

                  <div className="flex items-center justify-between p-3 rounded-xl bg-slate-950 border border-slate-855">
                    <div>
                      <span className="font-bold text-slate-200 block">Formal Research Re-evaluation</span>
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-amber-600 hover:bg-amber-500 disabled:opacity-50 text-white font-bold text-xs transition"
                    >
                  ...
                  {validationResult && (
                    <div className="p-3 rounded-xl bg-emerald-950/40 border border-emerald-800 space-y-1 text-emerald-300">
                      <span className="font-bold block">Validation Outcome: {validationResult.outcome}</span>
                      <p className="text-slate-300 font-sans text-[11px]">{validationResult.findings}</p>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {calibrationHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-amber-300">{ev.eventType}</td>
                        <td className="p-2.5 text-slate-300">{ev.calibrationId}</td>
                        <td className="p-2.5">
                          <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-slate-950 text-slate-300 border-slate-800">
                            {ev.afterState}
                          </span>
                        </td>
                        <td className="p-2.5 text-slate-300 font-sans truncate max-w-xs">{ev.reason}</td>
      ...
      {activeTab === "collectiveIntelligence" && (
        <div className="space-y-6">
          ...
          {collectiveSuccessMsg && (
            <div className="p-4 rounded-xl bg-indigo-950/60 border border-indigo-600/80 text-indigo-300 text-xs font-mono flex items-center gap-2">
          ...
          <div className="p-4 rounded-2xl bg-slate-950 border border-indigo-800/60 text-indigo-300 text-xs font-mono flex flex-col md:flex-row items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-2">
              <Network className="w-4 h-4 text-indigo-400 shrink-0" />
              <span className="font-bold">EPISTEMIC BOUNDARY:</span>
              <span className="text-slate-300">Cross-Project Correlation ≠ Verified Evidence &nbsp;|&nbsp; Association ≠ Causation &nbsp;|&nbsp; Independent Validation Required</span>
            </div>
            <span className="px-2.5 py-1 rounded bg-indigo-950/80 text-indigo-300 border border-indigo-700/80 text-[10px] uppercase font-bold shrink-0">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase border bg-indigo-950 text-indigo-300 border-indigo-800">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white px-4 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-slate-200 font-bold block">{federatedProjects.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">ELIGIBLE</span>
                <span className="text-emerald-400 font-bold block">{federatedProjects.filter((p) => p.eligibilityState === "ELIGIBLE" || p.eligibilityState === "ELIGIBLE_WITH_LIMITATIONS").length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">OBSERVATIONS</span>
                <span className="text-indigo-400 font-bold block">{collectiveObservations.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">CORRELATIONS</span>
                <span className="text-slate-200 font-bold block">{collectiveCorrelations.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">OPPORTUNITIES</span>
                <span className="text-amber-400 font-bold block">{collectiveOpportunities.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">CONTRADICTIONS</span>
                <span className="text-rose-400 font-bold block">{collectiveCorrelations.reduce((acc, c) => acc + c.contradictionCount, 0)}</span>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-left text-xs font-mono">
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {federatedProjects.map((proj) => (
                    <tr key={proj.federationRecordId} className="hover:bg-slate-855/40">
                      <td className="p-2.5 font-bold text-slate-200 truncate max-w-xs">{proj.projectTitle}</td>
                      <td className="p-2.5">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          proj.eligibilityState === "ELIGIBLE" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                          proj.eligibilityState === "ELIGIBLE_WITH_LIMITATIONS" ? "bg-blue-950 text-blue-300 border-blue-800" :
                          proj.eligibilityState === "PRIVACY_RESTRICTED" ? "bg-purple-950 text-purple-300 border-purple-800" :
                          "bg-rose-950 text-rose-300 border-rose-800"
                        }`}>
                          {proj.eligibilityState}
                        </span>
                      </td>
                      <td className="p-2.5 text-slate-400">{proj.privacyState}</td>
                      <td className="p-2.5 text-slate-300">{proj.evidenceClassificationSummary}</td>
                      <td className="p-2.5 text-indigo-300 font-bold">{proj.sourceIndependenceState}</td>
                      <td className="p-2.5 text-slate-400">{proj.availableBenchmarkDimensions.length} dimensions</td>
                      <td className="p-2.5">
                        <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-slate-950 text-slate-400 border-slate-800">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {collectiveCorrelations.map((corr) => (
                      <tr
                        ...
                        className={`hover:bg-slate-855/40 cursor-pointer ${
                          selectedCorrelation?.correlationId === corr.correlationId ? "bg-slate-855/60" : ""
                        }`}
                      >
                        <td className="p-2.5 font-bold text-slate-200">{corr.hardwareA}</td>
                        <td className="p-2.5 font-bold text-slate-300">{corr.hardwareB}</td>
                        <td className="p-2.5 text-slate-400">{corr.benchmarkSuite}</td>
                        <td className="p-2.5 text-indigo-300 font-bold">{corr.observedDeltaPercentage > 0 ? `+${corr.observedDeltaPercentage}%` : `${corr.observedDeltaPercentage}%`}</td>
                        <td className="p-2.5 text-slate-300">{corr.independentProjectsCount} projects</td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            corr.correlationState === "STRONG_ASSOCIATION" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            corr.correlationState === "REPEATED_ASSOCIATION" ? "bg-blue-950 text-blue-300 border-blue-800" :
                            corr.correlationState === "CONTRADICTED" ? "bg-rose-950 text-rose-300 border-rose-800" :
                            corr.correlationState === "CONFOUNDED" ? "bg-amber-950 text-amber-300 border-amber-800" :
                            "bg-slate-950 text-slate-400 border-slate-800"
                          }`}>
                        ...
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            corr.confidenceLevel === "HIGH" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            corr.confidenceLevel === "MODERATE" ? "bg-blue-950 text-blue-300 border-blue-800" :
                            "bg-slate-950 text-slate-400 border-slate-800"
                          }`}>
                        ...
                        <td className="p-2.5 text-slate-400">
                          {corr.contradictionCount > 0 ? (
                            <span className="text-rose-400 font-bold">{corr.contradictionCount} detected</span>
                          ) : (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  ...
                  <span className="px-2.5 py-1 rounded text-xs font-mono font-bold border bg-indigo-950 text-indigo-300 border-indigo-800">
                ...
                <div className="space-y-2 text-xs font-mono">
                  {inspectedCorrelationLineage?.links.map((link, idx) => (
                    <div key={idx} className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                      <div className="flex items-center justify-between">
                        <span className="text-indigo-400 font-bold text-[10px]">{idx + 1}. {link.stage}</span>
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          link.status === "VALID" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                          link.status === "WARNING" ? "bg-amber-950 text-amber-300 border-amber-800" :
                          "bg-slate-900 text-slate-400 border-slate-800"
                        }`}>
                          {link.status}
                        </span>
                      </div>
                      <span className="text-slate-200 font-bold block">{link.title}</span>
                      <p className="text-slate-400 font-sans text-[11px]">{link.detail}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
                ...
                <div className="space-y-3 text-xs font-mono">
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                    ...
                    <span className="text-slate-200 font-bold block">{selectedCorrelation.excludedProjectIds.length} projects excluded</span>
                  </div>
                    ...
                    {Object.keys(selectedCorrelation.exclusionReasons).length === 0 ? (
                      ...
                      <ul className="space-y-1 text-[11px] text-slate-400 font-sans">
                        {Object.entries(selectedCorrelation.exclusionReasons).map(([pair, rsn], idx) => (
                          <li key={idx} className="p-2 rounded bg-slate-900 border border-slate-800">
                            <span className="font-mono text-amber-300 block">{pair}</span>
                            <span>{rsn}</span>
                          </li>
                        ))}
                      </ul>
                  ...
                  {selectedCorrelation.contradictions.length > 0 && (
                    <div className="p-3 rounded-xl bg-rose-950/40 border border-rose-800 space-y-1 text-rose-300">
                      <span className="font-bold block">SURFACED EMPIRICAL CONTRADICTIONS:</span>
                      <ul className="list-disc pl-4 text-slate-300 font-sans text-[11px] space-y-1">
            ...
            {collectiveOpportunities.length === 0 ? (
              ...
              <div className="space-y-3">
                {collectiveOpportunities.map((opp) => (
                  <div key={opp.opportunityId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          opp.priority === "CRITICAL" ? "bg-rose-950 text-rose-300 border-rose-800" :
                          opp.priority === "HIGH" ? "bg-amber-950 text-amber-300 border-amber-800" :
                          "bg-blue-950 text-blue-300 border-blue-800"
                        }`}>
                          {opp.priority}
                        </span>
                        <span className="font-bold text-slate-200 text-xs">{opp.title}</span>
                      </div>
                      <button
                        onClick={() => handleValidateOpportunity(opp.opportunityId)}
                        disabled={opp.status === "QUEUED" || opp.status === "VALIDATED"}
                        className="px-3 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white font-bold text-xs transition shrink-0"
                      >
                        {opp.status === "QUEUED" ? "Queued in Phase 86" : "Create Research Validation Task"}
                      </button>
                    </div>
                    <p className="text-slate-400 font-sans text-xs">{opp.hypothesis}</p>
                    <div className="flex flex-wrap items-center gap-3 text-[10px] font-mono text-slate-500 pt-1 border-t border-slate-900">
                      <span>Affected Hardware: {opp.affectedHardware.join(", ")}</span>
                      <span>•</span>
                      <span>Benchmarks: {opp.affectedBenchmarks.join(", ")}</span>
                      <span>•</span>
                      <span className="text-amber-400">Validation: {opp.requiredValidationType}</span>
                    </div>
                  </div>
                ))}
              </div>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {collectiveHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-indigo-300">{ev.eventType}</td>
                        <td className="p-2.5 text-slate-300">{ev.targetId}</td>
                        <td className="p-2.5">
                          <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-slate-950 text-slate-300 border-slate-800">
                            {ev.afterState}
                          </span>
      ...
      {activeTab === "siliconRegression" && (
        <div className="space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-slate-950 border border-cyan-800/60 text-cyan-300 text-xs font-mono flex flex-col md:flex-row items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-2">
              <Cpu className="w-4 h-4 text-cyan-400 shrink-0" />
              <span className="font-bold">EPISTEMIC BOUNDARY:</span>
              <span className="text-slate-300">Silicon Regression Delta ≠ Unverified Factual Claim &nbsp;|&nbsp; Correlation ≠ Causation &nbsp;|&nbsp; Independent Research Validation Required</span>
            </div>
            <span className="px-2.5 py-1 rounded bg-cyan-950/80 text-cyan-300 border border-cyan-700/80 text-[10px] uppercase font-bold shrink-0">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase border bg-cyan-950 text-cyan-300 border-cyan-800">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-cyan-600 hover:bg-cyan-500 disabled:opacity-50 text-white px-4 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-slate-200 font-bold block">{siliconSeries.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">OBSERVATIONS</span>
                <span className="text-cyan-400 font-bold block">{siliconObservations.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">REGRESSIONS</span>
                <span className="text-rose-400 font-bold block">{siliconMatrix?.detectedRegressionsCount || 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">IMPROVEMENTS</span>
                <span className="text-emerald-400 font-bold block">{siliconMatrix?.detectedImprovementsCount || 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">CONFOUNDED</span>
                <span className="text-amber-400 font-bold block">{siliconMatrix?.confoundedCount || 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">OPPORTUNITIES</span>
                <span className="text-indigo-400 font-bold block">{siliconOpportunities.length}</span>
              </div>
            </div>
          </div>
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {siliconMatrix.pairs.map((pair) => (
                      <tr
                        ...
                        className={`hover:bg-slate-855/40 cursor-pointer ${
                          selectedRegressionPair?.pairId === pair.pairId ? "bg-slate-855/60" : ""
                        }`}
                      >
                        <td className="p-2.5 font-bold text-slate-200">
                        ...
                        <td className="p-2.5 text-slate-400">{pair.baselineObservation.benchmarkSuite}</td>
                        <td className="p-2.5 text-slate-300">{pair.baselineObservation.measuredScore} {pair.baselineObservation.metricUnit}</td>
                        <td className="p-2.5 text-slate-300">{pair.candidateObservation.measuredScore} {pair.candidateObservation.metricUnit}</td>
                        <td className="p-2.5 font-bold">
                          <span className={pair.percentageDelta < 0 ? "text-rose-400" : "text-emerald-400"}>
                            {pair.percentageDelta > 0 ? `+${pair.percentageDelta}%` : `${pair.percentageDelta}%`}
                          </span>
                        </td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            pair.regressionState === "CONFIRMED_EMPIRICAL_REGRESSION" ? "bg-rose-950 text-rose-300 border-rose-800" :
                            pair.regressionState === "LIKELY_REGRESSION" || pair.regressionState === "POSSIBLE_REGRESSION" ? "bg-amber-950 text-amber-300 border-amber-800" :
                            pair.regressionState === "IMPROVEMENT" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            pair.regressionState === "CONFOUNDED" ? "bg-purple-950 text-purple-300 border-purple-800" :
                            "bg-slate-950 text-slate-400 border-slate-800"
                          }`}>
                        ...
                        <td className="p-2.5 text-slate-400">
                          {pair.confounders.length > 0 ? (
                            <span className="text-amber-400">{pair.confounders.length} detected</span>
                          ) : (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              {siliconSeries.length === 0 ? (
                ...
                <div className="space-y-4">
                  {siliconSeries.map((s) => (
                    <div key={s.seriesId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-3">
                      <div className="flex items-center justify-between">
                        <div>
                          <span className="font-bold text-slate-200 text-xs block">{s.hardwareKey}</span>
                          <span className="text-[10px] text-slate-400 font-mono">{s.benchmarkSuite}</span>
                        </div>
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          s.seriesState === "CONFIRMED_EMPIRICAL_REGRESSION" ? "bg-rose-950 text-rose-300 border-rose-800" :
                          s.seriesState === "IMPROVEMENT" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                          "bg-slate-900 text-slate-400 border-slate-800"
                        }`}>
                          {s.seriesState}
                        </span>
                      ...
                      <div className="space-y-2">
                        {s.points.map((pt, idx) => (
                          <div key={pt.pointId} className="flex items-center justify-between p-2 rounded-lg bg-slate-900/80 border border-slate-800 text-[11px] font-mono">
                            <div className="flex items-center gap-2">
                              <span className="text-slate-500 text-[10px]">#{idx + 1}</span>
                              <span className="text-slate-300">{pt.driver || "Base Driver"}</span>
                              <span className="text-slate-500 text-[10px]">({new Date(pt.timestamp).toLocaleDateString()})</span>
                            </div>
                            <div className="flex items-center gap-3">
                              <span className="font-bold text-slate-200">{pt.measuredScore} {pt.metricUnit}</span>
                              <span className={`font-bold ${pt.deltaPercentage < 0 ? "text-rose-400" : pt.deltaPercentage > 0 ? "text-emerald-400" : "text-slate-400"}`}>
            ...
            {selectedRegressionPair ? (
              <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  ...
                  <span className="px-2.5 py-1 rounded text-xs font-mono font-bold border bg-cyan-950 text-cyan-300 border-cyan-800">
                ...
                <div className="space-y-2 text-xs font-mono">
                  {inspectedRegressionLineage?.links.map((link, idx) => (
                    <div key={idx} className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                      <div className="flex items-center justify-between">
                        <span className="text-cyan-400 font-bold text-[10px]">{idx + 1}. {link.stage}</span>
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          link.status === "CRITICAL" ? "bg-rose-950 text-rose-300 border-rose-800" :
                          link.status === "WARNING" ? "bg-amber-950 text-amber-300 border-amber-800" :
                          "bg-emerald-950 text-emerald-300 border-emerald-800"
                        }`}>
                          {link.status}
              ...
              <div className="slate-card p-6 bg-slate-900/90 border-slate-800 flex items-center justify-center text-xs font-mono text-slate-500">
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {siliconSynthesis.synthesisRecords.map((syn) => (
                  <div key={syn.synthesisId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2 font-mono text-xs">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-slate-200">{syn.architectureA} ({syn.generationA}) vs {syn.architectureB} ({syn.generationB})</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                        syn.direction === "REGRESSION" ? "bg-rose-950 text-rose-300 border-rose-800" :
                        syn.direction === "IMPROVEMENT" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                        "bg-slate-900 text-slate-400 border-slate-800"
                      }`}>
                        {syn.direction}
                      </span>
                    </div>
                    <div className="text-[11px] text-slate-400">{syn.benchmarkSuite}</div>
                    <div className="flex items-center justify-between pt-1 border-t border-slate-900">
                      <span className="text-slate-500 text-[10px]">Average Delta:</span>
                      <span className={`font-bold ${syn.observedDeltaPercentage < 0 ? "text-rose-400" : "text-emerald-400"}`}>
                  ...
                  <div key={opp.opportunityId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      ...
                      <button
                        ...
                        disabled={opp.status === "QUEUED" || opp.status === "VALIDATED"}
                        className="px-3 py-1.5 rounded-lg bg-cyan-600 hover:bg-cyan-500 disabled:opacity-50 text-white font-bold text-xs transition shrink-0"
                      >
                        {opp.status === "QUEUED" ? "Queued in Phase 86" : "Create Research Validation Task"}
                      </button>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-[10px] font-mono text-slate-500 pt-1 border-t border-slate-900">
                      ...
                      <span>Benchmarks: {opp.affectedBenchmarks.join(", ")}</span>
                      <span>•</span>
                      <span className="text-rose-400">Observed Delta: {opp.observedDeltaPercentage}%</span>
                    </div>
                  </div>
                ))}
              </div>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {siliconHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-cyan-300">{ev.eventType}</td>
                        <td className="p-2.5 text-slate-300">{ev.targetId}</td>
                        <td className="p-2.5">
                          <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-slate-950 text-slate-300 border-slate-800">
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-slate-950 border border-amber-800/60 text-amber-300 text-xs font-mono flex flex-col md:flex-row items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold">EPISTEMIC BOUNDARY:</span>
              <span className="text-slate-300">OBSERVED EVIDENCE &nbsp;≠&nbsp; SIMULATED ESTIMATE &nbsp;≠&nbsp; FORECAST TRAJECTORY &nbsp;|&nbsp; Explicit Research Validation Required</span>
            </div>
            <span className="px-2.5 py-1 rounded bg-amber-950/80 text-amber-300 border border-amber-700/80 text-[10px] uppercase font-bold shrink-0">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-slate-200 font-bold block">{forecastList.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">SIMULATIONS</span>
                <span className="text-amber-400 font-bold block">{simulationList.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">SCENARIOS</span>
                <span className="text-purple-400 font-bold block">{scenarioList.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">DEPRECATION RUNS</span>
                <span className="text-cyan-400 font-bold block">{deprecationList.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
              ...
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-indigo-400 font-bold block">{forecastOpportunities.length}</span>
              </div>
            </div>
          </div>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {forecastMatrix.rows.map((row) => (
                      <tr key={row.rowId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 font-bold text-slate-200">{row.architecture}</td>
                        <td className="p-2.5 text-cyan-300">{row.sku}</td>
                        <td className="p-2.5 text-slate-400">{row.benchmarkSuite}</td>
                        <td className="p-2.5 text-slate-300">{row.baselineScore}</td>
                        <td className="p-2.5 text-slate-300 font-bold">{row.latestObservedScore}</td>
                        <td className={`p-2.5 font-bold ${row.historicalDeltaPercentage < 0 ? "text-rose-400" : "text-emerald-400"}`}>
                          {row.historicalDeltaPercentage > 0 ? `+${row.historicalDeltaPercentage}%` : `${row.historicalDeltaPercentage}%`}
                        </td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            row.forecastDirection === "REGRESSION" ? "bg-rose-950 text-rose-300 border-rose-800" :
                            row.forecastDirection === "IMPROVEMENT" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            "bg-slate-950 text-slate-300 border-slate-800"
                          }`}>
                        ...
                        <td className="p-2.5">
                          <span className={`px-1.5 py-0.5 rounded text-[10px] font-bold ${
                            row.forecastConfidence === "HIGH" || row.forecastConfidence === "VERY_HIGH" ? "text-emerald-400 bg-emerald-950/40" :
                            row.forecastConfidence === "MODERATE" ? "text-amber-400 bg-amber-950/40" :
                            "text-slate-400 bg-slate-950"
                          }`}>
                            {row.forecastConfidence}
                          </span>
                        </td>
                        <td className="p-2.5 text-slate-400 truncate max-w-xs">{row.primaryConfounder}</td>
                        <td className="p-2.5 text-right">
                          <button
                            onClick={() => {
                            ...
                            className="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-bold transition"
                          >
                            Inspect Trajectory
                          </button>
                        </td>
          ...
          {selectedForecast && (
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-slate-100 text-sm">{selectedForecast.sku} &mdash; {selectedForecast.benchmarkSuite}</span>
                  </div>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {selectedForecast.projectedTrajectory.map((pt) => (
                      <tr key={pt.horizonStep} className="hover:bg-slate-855/40">
                        <td className="p-2.5 font-bold text-amber-400">+{pt.horizonStep}</td>
                        <td className="p-2.5 text-slate-300">{pt.stepLabel}</td>
                        <td className="p-2.5 font-bold text-slate-100">{pt.projectedScore} {pt.metricUnit}</td>
                        <td className="p-2.5 text-slate-400">{pt.lowerBoundScore}</td>
                        <td className="p-2.5 text-slate-400">{pt.upperBoundScore}</td>
                        <td className={`p-2.5 font-bold ${pt.projectedDeltaPercentage < 0 ? "text-rose-400" : "text-emerald-400"}`}>
                          {pt.projectedDeltaPercentage > 0 ? `+${pt.projectedDeltaPercentage}%` : `${pt.projectedDeltaPercentage}%`}
                        </td>
                        <td className="p-2.5 text-slate-400 truncate max-w-xs">{pt.uncertaintyReason}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="grid sm:grid-cols-2 gap-4 font-mono text-xs pt-2">
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5">
                  <span className="text-[10px] text-amber-400 uppercase font-bold block">DECLARED MODEL ASSUMPTIONS</span>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5">
                  <span className="text-[10px] text-cyan-400 uppercase font-bold block">EVIDENCE QUALITY &amp; BOUNDS</span>
                  <ul className="list-disc list-inside space-y-1 text-slate-300">
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white text-xs font-bold font-mono transition"
                >
                  Execute Simulation
                </button>
              </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {simulationList.map((sim) => (
                <div key={sim.simulationId} className="p-4 rounded-xl bg-slate-950 border border-purple-900/50 space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-purple-950 text-purple-300 border border-purple-800 font-mono">
                        SIMULATED ESTIMATE
                      </span>
                      <span className="font-bold text-slate-200 text-xs">{sim.sku}</span>
                    </div>
                  ...
                  <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 space-y-1 font-mono text-[11px]">
                    <div className="flex justify-between text-slate-400">
                      <span>Benchmark:</span>
                      <span className="text-slate-200 font-bold">{sim.benchmarkSuite}</span>
                    </div>
                    <div className="flex justify-between text-slate-400">
                      <span>Baseline Measured:</span>
                      <span className="text-slate-200 font-bold">{sim.baselineMeasuredScore} {sim.metricUnit}</span>
                    </div>
                    <div className="flex justify-between text-slate-400">
                      <span>Simulated Result:</span>
                      <span className="text-purple-300 font-bold">{sim.simulatedScore} {sim.metricUnit}</span>
                    </div>
                    <div className="flex justify-between text-slate-400">
                      <span>Assumed Overhead:</span>
                      <span className="text-amber-400 font-bold">{sim.assumedOverheadPercentage}%</span>
                    </div>
                  </div>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            ...
            <div className="space-y-3">
              {deprecationList.map((dep) => (
                <div key={dep.deprecationId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-slate-200 text-xs">{dep.instructionSet}</span>
                    </div>
                    <span className="text-rose-400 font-mono font-bold text-xs">
                  ...
                  <div className="text-xs text-slate-300 font-sans">
                    {dep.workloadDependencyDescription} &mdash; <span className="font-mono text-cyan-400">Fallback: {dep.fallbackPath}</span>
                  </div>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            ...
            <div className="grid sm:grid-cols-3 gap-3 font-mono text-xs">
              <div>
                <label className="text-[10px] text-slate-400 uppercase font-bold block mb-1">Scenario Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-[10px] text-slate-400 uppercase font-bold block mb-1">Assumed Overhead (%)</label>
                <input
                  type="number"
                  step="0.5"
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full py-2 rounded-xl bg-amber-600 hover:bg-amber-500 disabled:opacity-50 text-white font-bold text-xs transition"
                >
                  Create Scenario
                </button>
              </div>
                  ...
                  <div key={opp.opportunityId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      ...
                      <button
                        ...
                        disabled={opp.status === "QUEUED" || opp.status === "VALIDATED"}
                        className="px-3 py-1.5 rounded-lg bg-amber-600 hover:bg-amber-500 disabled:opacity-50 text-white font-bold text-xs transition shrink-0"
                      >
                        {opp.status === "QUEUED" ? "Queued in Phase 86" : "Create Research Validation Task"}
                      </button>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-[10px] font-mono text-slate-500 pt-1 border-t border-slate-900">
                      ...
                      <span>Benchmarks: {opp.affectedBenchmarks.join(", ")}</span>
                      <span>•</span>
                      <span className="text-amber-400">Modeled Delta: {opp.modeledDeltaPercentage}%</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="space-y-3">
                {inspectedForecastLineage.links.map((link) => (
                  <div key={link.stage} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 flex items-start justify-between gap-4 font-mono text-xs">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-amber-300">{link.title}</span>
                        <span className="text-slate-500 text-[10px]">[{link.stage}]</span>
                      </div>
                      <p className="text-slate-300 font-sans text-xs">{link.detail}</p>
                    </div>
                    <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-slate-900 text-slate-300 border-slate-800 shrink-0">
                      {link.status}
                    </span>
                  </div>
                ))}
      ...
      {activeTab === "testbenchControl" && (
        <div className="space-y-6">
          ...
          {/* Epistemic Boundary Principle Banner */}
          <div className="p-4 rounded-2xl bg-slate-950 border border-emerald-800/60 text-emerald-300 text-xs font-mono flex flex-col md:flex-row items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-2">
              <Compass className="w-4 h-4 text-emerald-400 shrink-0" />
              <span className="font-bold">EPISTEMIC BOUNDARY:</span>
              <span className="text-slate-300">PHYSICAL MEASUREMENT &nbsp;≠&nbsp; SIMULATION RESULT &nbsp;≠&nbsp; VERIFIED RESEARCH EVIDENCE &nbsp;|&nbsp; Explicit Validation Required</span>
            </div>
            <span className="px-2.5 py-1 rounded bg-emerald-950/80 text-emerald-300 border border-emerald-700/80 text-[10px] uppercase font-bold shrink-0">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase border bg-emerald-950 text-emerald-300 border-emerald-800">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white px-4 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-slate-200 font-bold block">{testbenchList.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">PLANNED TESTS</span>
                <span className="text-cyan-400 font-bold block">{testbenchPlans.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">EXPERIMENTS</span>
                <span className="text-emerald-400 font-bold block">{testbenchExperiments.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">SANDBOX SIMS</span>
                <span className="text-purple-400 font-bold block">{testbenchSimulations.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">COMPARISONS</span>
                <span className="text-amber-400 font-bold block">{testbenchComparisons.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">RESEARCH OPPS</span>
                <span className="text-indigo-400 font-bold block">{testbenchOpportunities.length}</span>
              </div>
            </div>
          </div>
          ...
          {testbenchCapabilities && (
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                ...
                <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold bg-slate-950 text-slate-300 border border-slate-800">
              ...
              <div className="grid sm:grid-cols-3 gap-4 font-mono text-xs">
                {/* Target Hardware */}
                <div className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                  <span className="text-[10px] text-slate-400 uppercase font-bold block">TARGET HARDWARE</span>
                  <div className="text-slate-200 font-bold">{testbenchCapabilities.cpu.model}</div>
                  <div className="text-cyan-300 font-bold">{testbenchCapabilities.gpu.model}</div>
                  <div className="text-slate-400 text-[11px]">{testbenchCapabilities.system.motherboard}</div>
                ...
                {/* Telemetry Sensors */}
                <div className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                  <span className="text-[10px] text-slate-400 uppercase font-bold block">TELEMETRY SENSORS</span>
                  <div className="flex justify-between text-slate-300">
                    <span>CPU Temp Sensor:</span>
                    <span className="text-emerald-400 font-bold">{testbenchCapabilities.sensors.cpuTemperatureSensor}</span>
                  </div>
                  <div className="flex justify-between text-slate-300">
                    <span>GPU Temp Sensor:</span>
                    <span className="text-emerald-400 font-bold">{testbenchCapabilities.sensors.gpuTemperatureSensor}</span>
                  </div>
                  <div className="flex justify-between text-slate-300">
                    <span>VRM / Hotspot:</span>
                    <span className="text-emerald-400 font-bold">{testbenchCapabilities.sensors.hotspotSensor}</span>
                  </div>
                  <div className="flex justify-between text-slate-300">
                ...
                <div className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                  <span className="text-[10px] text-slate-400 uppercase font-bold block">LABORATORY INSTRUMENTS</span>
                  <div className="flex justify-between text-slate-300">
                  ...
                  <div className="flex justify-between text-slate-300">
                    ...
                    <span className="text-emerald-400 font-bold">{testbenchCapabilities.sensors.onboardPowerTelemetry}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            ...
            <div className="space-y-3 font-mono text-xs">
              {testbenchPlans.map((plan) => (
                <div key={plan.planId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-3">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-950 text-emerald-300 border border-emerald-800">
                        {plan.benchmarkSuite}
                      </span>
                      <span className="text-slate-300 text-xs font-bold">{plan.resolution} &mdash; {plan.preset}</span>
                    </div>
                    <span className="text-[10px] text-slate-500">Plan Hash: {plan.executionPlanHash.slice(0, 16)}...</span>
                  </div>

                  <div className="grid sm:grid-cols-4 gap-2 text-[11px] text-slate-400 pt-1 border-t border-slate-900">
                    <div>API: <span className="text-slate-200 font-bold">{plan.renderingApi}</span></div>
                    <div>Ray Tracing: <span className="text-slate-200 font-bold">{plan.rayTracing ? "ON" : "OFF"}</span></div>
                    <div>Power Limit: <span className="text-amber-400 font-bold">{plan.powerLimitWatts}W</span></div>
                    <div>Runs: <span className="text-emerald-400 font-bold">{plan.runCount} (+{plan.warmupRuns} warmup)</span></div>
                  </div>
                </div>
              ))}
            </div>
          ...
          {testbenchExperiments.length > 0 && (
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-slate-100 text-sm">Physical Benchmark Experiment: {testbenchExperiments[0].experimentId}</span>
                  </div>
                  <p className="text-xs text-slate-400 font-mono">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-xl bg-rose-600 hover:bg-rose-500 disabled:opacity-40 text-white text-xs font-bold font-mono transition"
                  >
                    Emergency Stop
                  </button>
                </div>
              ...
              <div className="grid sm:grid-cols-4 gap-3 font-mono text-xs">
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855">
                  <span className="text-slate-500 block text-[10px]">CONSOLIDATED SCORE</span>
                  <span className="text-lg text-slate-100 font-bold block">
                    {testbenchExperiments[0].consolidatedScore || 0} <span className="text-xs font-normal text-slate-400">{testbenchExperiments[0].metricUnit}</span>
                  </span>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855">
                  ...
                  <span className="text-lg text-amber-400 font-bold block">
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {testbenchExperiments[0].runResults.map((run) => (
                      <tr key={run.runIndex} className="hover:bg-slate-855/40">
                        <td className="p-2.5 font-bold text-slate-200">#{run.runIndex + 1}</td>
                        <td className="p-2.5 text-slate-400">{run.isWarmup ? "WARMUP" : "MEASUREMENT"}</td>
                        <td className="p-2.5 font-bold text-slate-100">{run.rawScore} {run.metricUnit}</td>
                        <td className="p-2.5 text-slate-300">{run.normalizedScore}%</td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            run.status === "VALID" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            "bg-rose-950 text-rose-300 border-rose-800"
                          }`}>
                            {run.status}
                          </span>
                        </td>
                        <td className="p-2.5 text-amber-400">{run.telemetrySummary.avgPowerWatts}W</td>
                        <td className="p-2.5 text-slate-300">{run.telemetrySummary.maxGpuTempCelsius}°C</td>
                        <td className="p-2.5 text-rose-400 truncate max-w-xs">{run.discardedReason || "&mdash;"}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white text-xs font-bold font-mono transition shrink-0"
              >
            ...
            <div className="grid sm:grid-cols-5 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <label className="text-[10px] text-slate-400 block font-bold">CLOCK (GHZ)</label>
                <input
                  type="number"
                  step="0.1"
              ...
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <label className="text-[10px] text-slate-400 block font-bold">VECTOR WIDTH (BITS)</label>
                <select
              ...
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <label className="text-[10px] text-slate-400 block font-bold">L1 LATENCY (CYCLES)</label>
                <input
                  type="number"
              ...
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <label className="text-[10px] text-slate-400 block font-bold">MEM BW (GB/S)</label>
                <input
                  type="number"
              ...
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                <label className="text-[10px] text-slate-400 block font-bold">BRANCH PENALTY</label>
                <input
                  type="number"
            ...
            <div className="grid sm:grid-cols-2 gap-3 pt-2 font-mono text-xs">
              {testbenchSimulations.map((sim) => (
                <div key={sim.simulationId} className="p-4 rounded-xl bg-slate-950 border border-purple-900/50 space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-purple-950 text-purple-300 border border-purple-800">
                        {sim.simulationClassification}
                      </span>
                      <span className="font-bold text-slate-200 text-xs">{sim.name}</span>
                    </div>
                    <span className="text-purple-300 font-bold">{sim.simulatedScore} {sim.metricUnit}</span>
                  </div>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {testbenchComparisons.map((cmp) => (
                      <tr key={cmp.comparisonId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 font-bold text-slate-200">{cmp.sku}</td>
                        <td className="p-2.5 text-slate-400">{cmp.benchmarkSuite}</td>
                        <td className="p-2.5 text-emerald-400 font-bold">{cmp.physicalScore} {cmp.metricUnit}</td>
                        <td className="p-2.5 text-purple-300 font-bold">{cmp.simulatedScore} {cmp.metricUnit}</td>
                        <td className={`p-2.5 font-bold ${Math.abs(cmp.deltaPercentage) > 8 ? "text-rose-400" : "text-slate-300"}`}>
                          {cmp.deltaPercentage > 0 ? `+${cmp.deltaPercentage}%` : `${cmp.deltaPercentage}%`}
                        </td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            cmp.alignmentState === "ALIGNED" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            cmp.alignmentState === "PARTIALLY_ALIGNED" ? "bg-amber-950 text-amber-300 border-amber-800" :
                            "bg-rose-950 text-rose-300 border-rose-800"
                          }`}>
                            {cmp.alignmentState}
                          </span>
                        </td>
                        <td className="p-2.5 text-slate-300 font-sans truncate max-w-xs">{cmp.modelErrorAnalysis}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            {testbenchOpportunities.length === 0 ? (
              ...
              <div className="space-y-3">
                {testbenchOpportunities.map((opp) => (
                  <div key={opp.opportunityId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2 font-mono text-xs">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          opp.priority === "CRITICAL" ? "bg-rose-950 text-rose-300 border-rose-800" :
                        ...
                        <span className="font-bold text-slate-200 text-xs font-sans">{opp.title}</span>
                      </div>
                      <button
                        onClick={() => handleValidateTestbenchOpportunity(opp.opportunityId)}
                        disabled={opp.status === "QUEUED" || opp.status === "VALIDATED"}
                        className="px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white font-bold text-xs transition shrink-0"
                      >
                        {opp.status === "QUEUED" ? "Queued in Phase 86" : "Create Research Validation Task"}
                      </button>
                    </div>
                    <p className="text-slate-400 font-sans text-xs">{opp.hypothesis}</p>
                    <div className="flex flex-wrap items-center gap-3 text-[10px] text-slate-500 pt-1 border-t border-slate-900">
                      <span>Target SKUs: {opp.affectedSKUs.join(", ")}</span>
                      <span>•</span>
                      <span>Benchmarks: {opp.affectedBenchmarks.join(", ")}</span>
                      <span>•</span>
                      <span className="text-emerald-400">Observed Delta: {opp.observedDeltaPercentage}%</span>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-3">
                {inspectedTestbenchLineage.links.map((link) => (
                  <div key={link.stage} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 flex items-start justify-between gap-4 font-mono text-xs">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-emerald-300">{link.title}</span>
                        <span className="text-slate-500 text-[10px]">[{link.stage}]</span>
                      </div>
                      <p className="text-slate-300 font-sans text-xs">{link.detail}</p>
                    </div>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {testbenchHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-emerald-300">{ev.eventType}</td>
                        <td className="p-2.5 text-slate-300">{ev.targetId}</td>
                        <td className="p-2.5">
                          <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-slate-950 text-slate-300 border-slate-800">
                            {ev.afterState || "RECORDED"}
      ...
      {activeTab === "testbenchCluster" && (
        <div className="space-y-6">
          ...
          {/* Epistemic Boundary Principle Banner */}
          <div className="p-4 rounded-2xl bg-slate-950 border border-teal-800/60 text-teal-300 text-xs font-mono flex flex-col md:flex-row items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-2">
              <Compass className="w-4 h-4 text-teal-400 shrink-0" />
              <span className="font-bold">EPISTEMIC BOUNDARY:</span>
              <span className="text-slate-300">OBSERVED EVIDENCE &nbsp;≠&nbsp; PHYSICAL MEASUREMENT &nbsp;≠&nbsp; SIMULATION &nbsp;≠&nbsp; FORECAST &nbsp;≠&nbsp; CORRELATION &nbsp;≠&nbsp; VERIFIED RESEARCH EVIDENCE</span>
            </div>
            <span className="px-2.5 py-1 rounded bg-teal-950/80 text-teal-300 border border-teal-700/80 text-[10px] uppercase font-bold shrink-0">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase border bg-teal-950 text-teal-300 border-teal-800">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-slate-800 hover:bg-slate-700 text-teal-300 border border-teal-700/50 px-3.5 py-2 rounded-xl text-xs font-bold font-mono transition"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 bg-teal-600 hover:bg-teal-500 disabled:opacity-50 text-white px-4 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-slate-200 font-bold block">{clusterNodes.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
              ...
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-teal-300 font-bold block">{differentialMatrix?.totalComparisonsCount || 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">REPRODUCIBILITY</span>
                <span className="text-purple-400 font-bold block">{clusterReproducibility?.consistencyScore || 0}%</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">RESEARCH OPPS</span>
                <span className="text-indigo-400 font-bold block">{clusterOpportunities.length}</span>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-left text-xs font-mono">
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {clusterNodes.map((node) => (
                    <tr key={node.nodeId} className="hover:bg-slate-855/40">
                      <td className="p-2.5 font-bold text-slate-200">
                        <div>{node.name}</div>
                        <span className="text-[10px] text-slate-500 font-normal">{node.nodeId}</span>
                      </td>
                      <td className="p-2.5 text-slate-300">
                        <div className="text-teal-300 font-bold">{node.siliconIdentity.gpuSku}</div>
                        <div className="text-[10px] text-slate-400">{node.siliconIdentity.cpuModel}</div>
                      </td>
                      <td className="p-2.5 text-slate-400">
                        <div>Stepping: <span className="text-slate-200 font-bold">{node.siliconIdentity.cpuStepping}</span></div>
                        <div className="text-[10px]">{node.siliconIdentity.biosVersion}</div>
                      </td>
                      <td className="p-2.5 text-cyan-400">{node.siliconIdentity.gpuDriverVersion}</td>
                      <td className="p-2.5">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          node.healthStatus === "HEALTHY" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                          node.healthStatus === "BUSY" ? "bg-cyan-950 text-cyan-300 border-cyan-800" :
                          "bg-rose-950 text-rose-300 border-rose-800"
                        }`}>
                          {node.healthStatus}
                        </span>
                      ...
                      <td className="p-2.5">
                        <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-teal-950 text-teal-300 border-teal-800">
                          {node.authorizationState}
                        </span>
                      </td>
                      <td className="p-2.5 text-slate-400">{node.activeLock}</td>
                      <td className="p-2.5">
                        <button
                          onClick={() => handleAbortClusterNode(node.nodeId)}
                          className="px-2 py-1 rounded bg-rose-950/80 hover:bg-rose-900 border border-rose-800 text-rose-300 text-[10px] font-bold transition"
                        >
                          Emergency Stop
                        </button>
                      </td>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            ...
            <div className="space-y-3 font-mono text-xs">
              {clusterJobs.map((job, idx) => (
                <div key={job.jobId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="text-slate-500 font-bold">#{idx + 1}</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                        job.priority === "CRITICAL" ? "bg-rose-950 text-rose-300 border-rose-800" :
                        job.priority === "HIGH" ? "bg-amber-950 text-amber-300 border-amber-800" :
                        "bg-blue-950 text-blue-300 border-blue-800"
                      }`}>
                        {job.priority}
                      </span>
                      <span className="font-bold text-slate-200">{job.benchmarkSuite}</span>
                    </div>
                    <div className="text-[10px] text-slate-400 flex flex-wrap gap-2">
                      ...
                      {job.allocatedNodeId && (
                        <>
                          <span>•</span>
                          <span className="text-teal-400 font-bold">Allocated: {job.allocatedNodeId}</span>
                        </>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <span className={`px-2.5 py-1 rounded text-[10px] font-bold border ${
                      job.status === "COMPLETED" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                      job.status === "ALLOCATED" ? "bg-cyan-950 text-cyan-300 border-cyan-800" :
                      job.status === "RUNNING" ? "bg-purple-950 text-purple-300 border-purple-800 animate-pulse" :
                      "bg-slate-900 text-slate-400 border-slate-800"
                    }`}>
                      {job.status}
                    </span>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div>
                ...
                <p className="text-[11px] text-slate-400 font-sans">
                  Cross-node hardware, firmware, driver, and stepping deltas with strict non-causal assertion guards (<span className="font-mono text-teal-400">isCausallyEstablished: false</span>).
                </p>
              </div>
            </div>
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {differentialMatrix.entries.map((diff) => (
                      ...
                      >
                        ...
                        <td className={`p-2.5 font-bold ${Math.abs(diff.deltaPercentage) > 5 ? "text-amber-400" : "text-slate-300"}`}>
                        ...
                        <td className="p-2.5 text-slate-400">
                          ...
                          <div className="text-[10px] text-emerald-400">{diff.perfPerWattDelta !== undefined ? `${diff.perfPerWattDelta > 0 ? `+${diff.perfPerWattDelta}` : diff.perfPerWattDelta} FPS/W` : ""}</div>
                        </td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            diff.differentialClassification === "IDENTICAL_CONFIGURATION" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            diff.differentialClassification === "SILICON_VARIANT" ? "bg-teal-950 text-teal-300 border-teal-800" :
                            diff.differentialClassification === "DRIVER_VARIANT" ? "bg-cyan-950 text-cyan-300 border-cyan-800" :
                            "bg-amber-950 text-amber-300 border-amber-800"
                          }`}>
                            {diff.differentialClassification}
                          </span>
                        </td>
                        <td className="p-2.5 text-slate-300 font-sans truncate max-w-xs">{diff.primaryDivergenceFactor}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          {clusterReproducibility && (
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                ...
                <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold bg-slate-950 text-purple-300 border border-slate-800">
              ...
              <div className="grid sm:grid-cols-3 gap-3 font-mono text-xs">
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855">
                  ...
                  <span className="text-lg text-slate-100 font-bold block">{clusterReproducibility.consistencyScore}%</span>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855">
                  ...
                  <span className="text-lg text-teal-300 font-bold block">
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="space-y-3 font-mono text-xs">
                {clusterOutliers.map((outlier) => (
                  <div key={outlier.outlierId} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-slate-200">Run #{outlier.runIndex + 1}: {outlier.rawScore} {outlier.metricUnit}</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                        outlier.outlierStatus === "NORMAL" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                        "bg-amber-950 text-amber-300 border-amber-800"
                      }`}>
                        {outlier.outlierStatus}
                      </span>
                    </div>
                    <p className="text-[11px] text-slate-400 font-sans">{outlier.reason}</p>
              ...
              {clusterContradictions.length === 0 ? (
                ...
                <div className="space-y-3 font-mono text-xs">
                  {clusterContradictions.map((contra) => (
                    <div key={contra.contradictionId} className="p-3.5 rounded-xl bg-slate-950 border border-rose-900/50 space-y-1.5">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-rose-300">{contra.contradictionStatus} ({contra.variancePercentage}% delta)</span>
                        <span className="text-[10px] text-slate-400">{contra.benchmarkSuite}</span>
                      </div>
                      <p className="text-[11px] text-slate-300 font-sans">{contra.possibleExplanations[0]}</p>
                      <div className="text-[10px] text-rose-400 pt-1 border-t border-slate-900">
                  ...
                  <div key={opp.opportunityId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2 font-mono text-xs">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      ...
                      <button
                        ...
                        disabled={opp.status === "QUEUED" || opp.status === "VALIDATED"}
                        className="px-3 py-1.5 rounded-lg bg-teal-600 hover:bg-teal-500 disabled:opacity-50 text-white font-bold text-xs transition shrink-0"
                      >
                        {opp.status === "QUEUED" ? "Queued in Phase 86" : "Create Research Validation Task"}
                      </button>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-[10px] text-slate-500 pt-1 border-t border-slate-900">
                      ...
                      <span>Benchmarks: {opp.affectedBenchmarks.join(", ")}</span>
                      <span>•</span>
                      <span className="text-teal-400">Observed Delta: {opp.observedDeltaPercentage}%</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="space-y-3">
                {selectedClusterLineage.stages.map((stage) => (
                  <div key={stage.stage} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 flex items-start justify-between gap-4 font-mono text-xs">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-teal-300">{stage.title}</span>
                        <span className="text-slate-500 text-[10px]">[{stage.stage}]</span>
                      </div>
                      <p className="text-slate-300 font-sans text-xs">{stage.detail}</p>
                    </div>
                    <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-slate-900 text-slate-300 border-slate-800 shrink-0">
                      {stage.status}
                    </span>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {clusterHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-teal-300">{ev.eventType}</td>
                        <td className="p-2.5 text-slate-300">{ev.targetId}</td>
                        <td className="p-2.5 text-slate-400">{ev.actor}</td>
                        <td className="p-2.5 text-slate-300 font-sans truncate max-w-xs">{ev.reason}</td>
                      </tr>
                    ))}
                  </tbody>
      ...
      {activeTab === "crossLabRegression" && (
        <div className="space-y-6">
          {crossLabSuccessMsg && (
            <div className="p-4 rounded-xl bg-sky-950/60 border border-sky-600/80 text-sky-300 text-xs font-mono flex items-center gap-2">
          ...
          {/* Epistemic Boundary Principle Banner */}
          <div className="p-4 rounded-2xl bg-slate-950 border border-sky-800/60 text-sky-300 text-xs font-mono flex flex-col md:flex-row items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-2">
              <Compass className="w-4 h-4 text-sky-400 shrink-0" />
              <span className="font-bold">EPISTEMIC BOUNDARY:</span>
              <span className="text-slate-300">OBSERVED EVIDENCE &nbsp;≠&nbsp; PHYSICAL MEASUREMENT &nbsp;≠&nbsp; SIMULATION &nbsp;≠&nbsp; FORECAST &nbsp;≠&nbsp; CORRELATION &nbsp;≠&nbsp; EMPIRICAL SYNTHESIS &nbsp;≠&nbsp; VERIFIED RESEARCH EVIDENCE</span>
            </div>
            <span className="px-2.5 py-1 rounded bg-sky-950/80 text-sky-300 border border-sky-700/80 text-[10px] uppercase font-bold shrink-0">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase border bg-sky-950 text-sky-300 border-sky-800">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-sky-600 hover:bg-sky-500 disabled:opacity-50 text-white px-4 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-slate-200 font-bold block">{crossLabLaboratories.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">OBSERVATIONS</span>
                <span className="text-emerald-400 font-bold block">
              ...
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">REGRESSIONS</span>
                <span className="text-rose-400 font-bold block">{crossLabMatrix?.repeatedRegressionsCount || 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">CONTRADICTIONS</span>
                <span className="text-amber-400 font-bold block">{crossLabContradictions.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">LEDGER ENTRIES</span>
                <span className="text-sky-300 font-bold block">{crossLabLedger.length}</span>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-left text-xs font-mono">
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {crossLabLaboratories.map((lab) => (
                    <tr key={lab.laboratoryId} className="hover:bg-slate-855/40">
                      <td className="p-2.5 font-bold text-slate-200">
                        <div>{lab.name}</div>
                        <span className="text-[10px] text-slate-500 font-normal">{lab.location || "Remote Facility"}</span>
                      </td>
                      <td className="p-2.5 text-cyan-400">{lab.clusterId}</td>
                      <td className="p-2.5 text-slate-300 font-sans max-w-xs truncate">{lab.hardwareSummary}</td>
                      <td className="p-2.5">
                        <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-emerald-950 text-emerald-300 border-emerald-800">
                          {lab.status}
                        </span>
                      </td>
                      <td className="p-2.5 text-slate-400 text-[10px]">{lab.laboratoryFingerprint}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div>
                ...
                <p className="text-[11px] text-slate-400 font-sans">
                  Consolidated paired observations across independent laboratory nodes with strict non-causal epistemic bounds (<span className="font-mono text-sky-400">isCausallyEstablished: false</span>).
                </p>
              </div>
            </div>
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {crossLabMatrix.comparisons.map((cmp) => (
                      ...
                      >
                        ...
                        <td className="p-2.5 text-slate-300">
                          <div className="text-sky-300 font-bold">{cmp.labASku} vs {cmp.labBSku}</div>
                          <div className="text-[10px] text-slate-400">{cmp.benchmarkSuite}</div>
                        </td>
                        <td className="p-2.5 text-slate-100 font-bold">
                          {cmp.labAScore} vs {cmp.labBScore} {cmp.metricUnit}
                        </td>
                        <td className={`p-2.5 font-bold ${Math.abs(cmp.percentageDelta) > 5 ? "text-amber-400" : "text-slate-300"}`}>
                        ...
                        <td className="p-2.5 text-slate-400">
                          ...
                          <div className="text-[10px] text-emerald-400">{cmp.perfPerWattDelta !== undefined ? `${cmp.perfPerWattDelta > 0 ? `+${cmp.perfPerWattDelta}` : cmp.perfPerWattDelta} FPS/W` : ""}</div>
                        </td>
                        <td className="p-2.5">
                          <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                            cmp.synthesisClassification === "REPEATED_IMPROVEMENT" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                            cmp.synthesisClassification === "REPEATED_REGRESSION" ? "bg-rose-950 text-rose-300 border-rose-800" :
                            cmp.synthesisClassification === "CONTRADICTED" ? "bg-amber-950 text-amber-300 border-amber-800" :
                        ...
                        <td className="p-2.5">
                          <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-sky-950 text-sky-300 border-sky-800">
              ...
              {crossLabSeries.map((s) => (
                <div key={s.seriesId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-3">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-900 pb-2">
                    <div>
                      <span className="font-bold text-slate-100 text-sm">{s.sku} (Stepping {s.stepping})</span>
                      <span className="text-[10px] text-slate-500 block">{s.benchmarkSuite} • {s.architecture} Architecture</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className={`px-2.5 py-1 rounded text-[10px] font-bold border ${
                        s.driftClassification === "REPEATED_IMPROVEMENT" ? "bg-emerald-950 text-emerald-300 border-emerald-800" :
                        s.driftClassification === "REPEATED_REGRESSION" ? "bg-rose-950 text-rose-300 border-rose-800" :
                        s.driftClassification === "OBSERVED_DRIFT" ? "bg-amber-950 text-amber-300 border-amber-800" :
                        "bg-slate-900 text-slate-300 border-slate-800"
                      }`}>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-[11px]">
                    <div className="p-2.5 rounded-lg bg-slate-900/60 border border-slate-800">
                      ...
                      <span className="font-bold text-slate-200">{s.baselineScore} {s.points[0]?.metricUnit || "fps"}</span>
                    </div>
                    <div className="p-2.5 rounded-lg bg-slate-900/60 border border-slate-800">
                      <span className="text-slate-500 block text-[10px]">LATEST SCORE</span>
                      <span className="font-bold text-sky-300">{s.latestScore} {s.points[s.points.length - 1]?.metricUnit || "fps"}</span>
                    </div>
                    <div className="p-2.5 rounded-lg bg-slate-900/60 border border-slate-800">
                      <span className="text-slate-500 block text-[10px]">MIN / MAX / MEDIAN</span>
                      <span className="font-bold text-slate-300">{s.minimumScore} / {s.maximumScore} / {s.medianScore}</span>
                    </div>
                    <div className="p-2.5 rounded-lg bg-slate-900/60 border border-slate-800">
                      <span className="text-slate-500 block text-[10px]">DRIVER REVISIONS</span>
                      <span className="text-slate-300 text-[10px] truncate block">{s.driverTransitions.join(", ")}</span>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="grid sm:grid-cols-2 gap-6">
              ...
              {crossLabContradictions.length === 0 ? (
                ...
                <div className="space-y-3 font-mono text-xs">
                  {crossLabContradictions.map((contra) => (
                    <div key={contra.contradictionId} className="p-3.5 rounded-xl bg-slate-950 border border-rose-900/50 space-y-1.5">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-rose-300">{contra.labAId} ({contra.labAScore}) vs {contra.labBId} ({contra.labBScore} {contra.metricUnit})</span>
                        <span className="text-[10px] text-slate-400">{contra.variancePercentage}% delta</span>
                      </div>
                      <p className="text-[11px] text-slate-300 font-sans">{contra.explanation}</p>
                      <div className="text-[10px] text-rose-400 pt-1 border-t border-slate-900">
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                ...
                <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-slate-950 text-sky-300 border border-slate-800">
              ...
              {crossLabReproducibility && (
                <div className="space-y-3 font-mono text-xs">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                      <span className="text-slate-500 block text-[10px]">CONSISTENCY SCORE</span>
                      <span className="text-lg font-bold text-emerald-400">{crossLabReproducibility.consistencyScore}%</span>
                    </div>
                    <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
              ...
              {crossLabOpportunities.map((opp) => (
                <div key={opp.opportunityId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2 font-mono text-xs">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-sky-600 hover:bg-sky-500 disabled:opacity-50 text-white font-bold text-xs transition"
                      >
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-[10px] text-slate-500 pt-1 border-t border-slate-900">
                    ...
                    <span>•</span>
                    <span className="text-sky-400">Observed Delta: +{opp.observedDeltaPercentage}%</span>
                  </div>
                </div>
              ))}
            </div>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {crossLabLedger.map((entry) => (
                      <tr key={entry.ledgerEntryId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 font-bold text-emerald-300">{entry.ledgerEntryId}</td>
                        <td className="p-2.5 text-slate-200 font-sans max-w-xs">{entry.claimOrFinding}</td>
                        <td className="p-2.5 text-cyan-400">{entry.validationTaskId}</td>
                        <td className="p-2.5 text-slate-100 font-bold">{entry.confidence}%</td>
                        <td className="p-2.5">
                          <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-slate-950 text-slate-400 border-slate-800">
              ...
              <div className="space-y-3">
                {selectedCrossLabLineage.stages.map((stage) => (
                  <div key={stage.stage} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 flex items-start justify-between gap-4 font-mono text-xs">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-sky-300">{stage.title}</span>
                        <span className="text-slate-500 text-[10px]">[{stage.stage}]</span>
                      </div>
                      <p className="text-slate-300 font-sans text-xs">{stage.detail}</p>
                    </div>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {crossLabHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-sky-300">{ev.eventType}</td>
                        <td className="p-2.5 text-slate-300">{ev.targetId}</td>
                        <td className="p-2.5 text-slate-400">{ev.actor}</td>
                        <td className="p-2.5 text-slate-300 font-sans truncate max-w-xs">{ev.reason}</td>
                      </tr>
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-slate-950 border border-indigo-800/60 text-indigo-300 text-xs font-mono flex flex-col md:flex-row items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold">EPISTEMIC BOUNDARY:</span>
              <span className="text-slate-300">TRACE OBSERVATION &nbsp;≠&nbsp; BOTTLENECK ATTRIBUTION &nbsp;≠&nbsp; CAUSAL EXPLANATION &nbsp;≠&nbsp; SIMULATION &nbsp;≠&nbsp; FORECAST &nbsp;≠&nbsp; EMPIRICAL SYNTHESIS &nbsp;≠&nbsp; VERIFIED RESEARCH EVIDENCE</span>
            </div>
            <span className="px-2.5 py-1 rounded bg-indigo-950/80 text-indigo-300 border border-indigo-700/80 text-[10px] uppercase font-bold shrink-0">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                ...
                <span className="text-slate-200 font-bold block">{microTraces.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">ATTRIBUTIONS</span>
                <span className="text-indigo-400 font-bold block">{microAttributions.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">CROSS-GEN COMPARISONS</span>
                <span className="text-cyan-400 font-bold block">{microComparisons.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">PHYSICAL RECONCILIATIONS</span>
                <span className="text-emerald-400 font-bold block">{microPhysicalReconciliations.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">LEDGER RECONCILIATIONS</span>
                <span className="text-sky-300 font-bold block">{microLedgerReconciliations.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">RESEARCH HYPOTHESES</span>
                <span className="text-amber-400 font-bold block">{microOpportunities.length}</span>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-left text-xs font-mono">
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {microTraces.map((trace) => (
                    <tr key={trace.traceId} className="hover:bg-slate-855/40">
                      <td className="p-2.5 font-bold text-slate-200">
                        <div>{trace.traceId}</div>
                        <span className="text-[10px] text-slate-400 font-normal">{trace.hardwareTarget}</span>
                      </td>
                      <td className="p-2.5 text-slate-300">
                        <div>{trace.cpuModel} (Stepping {trace.cpuStepping})</div>
                        <div className="text-[10px] text-indigo-300">{trace.gpuModel} • {trace.gpuArchitecture}</div>
                      </td>
                      ...
                      <td className="p-2.5 text-slate-400">
                        ...
                        <div className="text-[10px] text-cyan-400">{trace.observedClockGhz ? `${trace.observedClockGhz} GHz` : "—"}</div>
                      </td>
              ...
              {!microNormalizedList[0] ? (
                ...
                <div className="space-y-3 font-mono text-xs">
                  {microNormalizedList[0].stalls.map((stall) => (
                    <div key={stall.decompositionId} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-slate-200">{stall.category}</span>
                        <span className="font-bold text-indigo-300">{stall.normalizedValue}%</span>
                      </div>
              ...
              <div className="space-y-3 font-mono text-xs">
                {microAttributions.map((attrib) => (
                  <div
                    ...
                    className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2 cursor-pointer hover:border-indigo-700/60 transition"
                  >
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-indigo-300">{attrib.attributionType.replace(/_/g, " ")}</span>
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-slate-900 text-slate-400 border-slate-800">
                        {attrib.isCausallyEstablished ? "CAUSAL_ESTABLISHED" : "NON_CAUSAL_DEFAULT"}
                      </span>
                    </div>
                    <p className="text-[11px] text-slate-300 font-sans">{attrib.summary}</p>
                    <div className="space-y-1 text-[10px] text-slate-400 pt-1 border-t border-slate-900 font-sans">
                      <div><strong className="text-slate-300">Supporting:</strong> {attrib.supportingSignals.join("; ")}</div>
                      {attrib.contradictingSignals.length > 0 && (
                        <div><strong className="text-amber-400">Contradicting:</strong> {attrib.contradictingSignals.join("; ")}</div>
                      )}
                    </div>
                  </div>
                ))}
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {microComparisons.map((comp) => (
                      <tr key={comp.comparisonId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 font-bold text-slate-200">
                        ...
                        <td className={`p-2.5 font-bold ${comp.performanceDeltaPercentage > 0 ? "text-emerald-400" : "text-rose-400"}`}>
                        ...
                        <td className="p-2.5">
                          <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-indigo-950 text-indigo-300 border-indigo-800">
                            {comp.classification}
                          </span>
                        </td>
                        <td className="p-2.5 text-slate-400 font-sans text-[11px] max-w-xs truncate">
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="space-y-3 font-mono text-xs">
                {microPhysicalReconciliations.map((rec) => (
                  <div key={rec.reconciliationId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-slate-200">Physical Benchmark: {rec.benchmarkScore} {rec.metricUnit}</span>
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-emerald-950 text-emerald-300 border-emerald-800">
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="space-y-3 font-mono text-xs">
                {microLedgerReconciliations.map((lRec) => (
                  <div key={lRec.reconciliationId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-sky-300">Entry: {lRec.ledgerEntryId || "New Workload"}</span>
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-sky-950 text-sky-300 border-sky-800">
                        {lRec.reconciliationStatus}
                      </span>
                    </div>
                    <p className="text-[11px] text-slate-300 font-sans">{lRec.agreementSummary}</p>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="space-y-3">
                {selectedMicroLineage.stages.map((stage) => (
                  <div key={stage.stage} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 flex items-start justify-between gap-4 font-mono text-xs">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-indigo-300">{stage.title}</span>
                        <span className="text-slate-500 text-[10px]">[{stage.stage}]</span>
                      </div>
                      <p className="text-slate-300 font-sans text-xs">{stage.detail}</p>
                    </div>
      ...
      {activeTab === "coDesign" && (
        <div className="space-y-6">
          {coDesignSuccessMsg && (
            <div className="p-4 rounded-xl bg-fuchsia-950/60 border border-fuchsia-600/80 text-fuchsia-300 text-xs font-mono flex items-center gap-2">
          ...
          {/* Epistemic Boundary Principle Banner */}
          <div className="p-4 rounded-2xl bg-slate-950 border border-fuchsia-800/60 text-fuchsia-300 text-xs font-mono flex flex-col md:flex-row items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-2">
              <Compass className="w-4 h-4 text-fuchsia-400 shrink-0" />
              <span className="font-bold">EPISTEMIC BOUNDARY:</span>
              <span className="text-slate-300">OBSERVED EVIDENCE &nbsp;≠&nbsp; PHYSICAL MEASUREMENT &nbsp;≠&nbsp; EXECUTION TRACE &nbsp;≠&nbsp; HARDWARE COUNTER &nbsp;≠&nbsp; SIMULATION &nbsp;≠&nbsp; FORECAST &nbsp;≠&nbsp; CORRELATION &nbsp;≠&nbsp; EMPIRICAL SYNTHESIS &nbsp;≠&nbsp; MICROARCHITECTURAL ATTRIBUTION &nbsp;≠&nbsp; CO-DESIGN SIMULATION &nbsp;≠&nbsp; VERIFIED RESEARCH EVIDENCE</span>
            </div>
            <span className="px-2.5 py-1 rounded bg-fuchsia-950/80 text-fuchsia-300 border border-fuchsia-700/80 text-[10px] uppercase font-bold shrink-0">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase border bg-fuchsia-950 text-fuchsia-300 border-fuchsia-800">
                    CO-DESIGN WORKBENCH
                  </span>
                  <span className="text-xs font-mono text-slate-400">
              ...
              <div className="flex flex-wrap items-center gap-2 shrink-0">
                <button
                  ...
                  className="flex items-center gap-1.5 bg-fuchsia-600 hover:bg-fuchsia-500 disabled:opacity-50 text-white px-4 py-2 rounded-xl text-xs font-bold font-mono shadow-sm transition"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-6 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">SCENARIOS</span>
                <span className="text-slate-200 font-bold block">{coDesignScenarios.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">EMPIRICAL BASELINES</span>
                <span className="text-fuchsia-400 font-bold block">{coDesignBaselines.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">SIMULATIONS</span>
                <span className="text-cyan-400 font-bold block">{coDesignSimulations.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">ALIGNMENTS</span>
                <span className="text-emerald-400 font-bold block">{coDesignAlignments.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">SENSITIVITIES</span>
                <span className="text-indigo-400 font-bold block">{coDesignSensitivities[0]?.sensitivities.length || 0}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">HYPOTHESES</span>
                <span className="text-amber-400 font-bold block">{coDesignOpportunities.length}</span>
              </div>
            </div>
          </div>
          ...
          {coDesignScenarios[0] && (
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-3">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 rounded text-[10px] font-mono border bg-slate-950 text-slate-400 border-slate-800">
                      Rev {coDesignScenarios[0].revision}
                    </span>
                    <span className="px-2 py-0.5 rounded text-[10px] font-mono border bg-slate-950 text-slate-500 border-slate-800">
                      {coDesignScenarios[0].modelVersion}
                    </span>
                  </div>
                  <p className="text-[11px] text-slate-400 font-sans">{coDesignScenarios[0].description}</p>
                </div>
                <div className="text-right font-mono text-[11px] text-slate-400 shrink-0">
                  <div>Target: <strong className="text-slate-200">{coDesignScenarios[0].targetHardware}</strong></div>
              ...
              {coDesignBaselines[0] && (
                <div className="p-4 rounded-xl bg-slate-950 border border-slate-855 flex flex-col sm:flex-row sm:items-center justify-between gap-3 font-mono text-xs">
                  <div className="space-y-0.5">
                    <span className="text-[10px] text-slate-500 uppercase">Empirical Physical Reference Baseline</span>
                    <div className="text-slate-200 font-bold">{coDesignBaselines[0].hardwareTarget}</div>
                    <div className="text-[11px] text-fuchsia-300 font-sans">
                  ...
                  <div className="flex items-center gap-4 text-right">
                    <div>
                      ...
                      <span className="text-emerald-400 font-bold text-sm">{coDesignBaselines[0].measuredScoreFPS} FPS</span>
                    </div>
                    <div>
                      <span className="text-slate-500 block text-[10px]">POWER / EFFICIENCY</span>
                      <span className="text-slate-300 font-bold">{coDesignBaselines[0].measuredPowerWatts}W / {coDesignBaselines[0].measuredPerfPerWatt} FPS/W</span>
                    </div>
                    <div>
                      <span className="text-slate-500 block text-[10px]">PRIMARY STALL</span>
                      <span className="text-indigo-300 font-bold">{coDesignBaselines[0].primaryBottleneckAttribution || "MEMORY_BOUND"}</span>
                    </div>
                  </div>
                </div>
              )}
          ...
          {coDesignScenarios[0] && (
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-5">
              <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                <div>
                  <h3 className="text-sm font-bold text-slate-100 flex items-center gap-2">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {Object.entries(coDesignScenarios[0].parameters).map(([paramKey, param]) => (
                  <div key={paramKey} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2.5 font-mono text-xs">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-slate-200 truncate pr-2">{param.name}</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            {coDesignSimulations[0] && (
              <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  ...
                  <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold border bg-fuchsia-950 text-fuchsia-300 border-fuchsia-800">
                    SIMULATED_ESTIMATE
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 font-mono text-xs">
                  <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                    ...
                    <span className="text-fuchsia-300 font-bold text-lg">{coDesignSimulations[0].simulatedScoreFPS} FPS</span>
                    <div className={`text-[10px] font-bold ${coDesignSimulations[0].deltaPercentage >= 0 ? "text-emerald-400" : "text-rose-400"}`}>
                  ...
                  <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1">
                    <span className="text-slate-500 block text-[10px]">POWER &amp; EFFICIENCY</span>
                    <span className="text-slate-200 font-bold text-lg">{coDesignSimulations[0].simulatedPowerWatts}W</span>
                ...
                <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5 font-mono text-xs">
                  <div className="flex items-center justify-between">
                    <span className="text-slate-400 text-[11px]">95% Simulation Confidence Interval:</span>
                ...
                <div className="space-y-2 font-mono text-xs">
                  <span className="text-slate-400 text-[11px] block font-bold">Modeled Stall Cycle Breakdown:</span>
                  {Object.entries(coDesignSimulations[0].bottleneckDistribution).map(([cat, share]) => (
                    <div key={cat} className="space-y-1">
                      <div className="flex items-center justify-between text-[11px]">
                        ...
                        <span className="text-fuchsia-300 font-bold">{share}%</span>
                      </div>
            ...
            {coDesignAlignments[0] && (
              <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
                  ...
                  <table className="w-full text-left text-xs font-mono">
                    ...
                    <tbody className="divide-y divide-slate-800/60">
                      {coDesignAlignments[0].metricDifferences.map((diff) => (
                        <tr key={diff.metric} className="hover:bg-slate-855/40">
                          <td className="p-2.5 font-bold text-slate-200">{diff.metric}</td>
                          <td className="p-2.5 text-emerald-400">{diff.physicalValue} {diff.unit}</td>
                          <td className="p-2.5 text-fuchsia-300">{diff.simulatedValue} {diff.unit}</td>
                          <td className={`p-2.5 font-bold ${diff.deltaPercentage === 0 ? "text-slate-400" : diff.deltaPercentage > 0 ? "text-emerald-400" : "text-rose-400"}`}>
                            {diff.deltaPercentage > 0 ? `+${diff.deltaPercentage}%` : `${diff.deltaPercentage}%`}
                          </td>
                        </tr>
                      ))}
                ...
                <p className="text-[11px] text-slate-300 font-sans p-3 rounded-xl bg-slate-950 border border-slate-855">
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 font-mono text-xs">
                {coDesignSensitivities[0].sensitivities.slice(0, 8).map((sens) => (
                  <div key={sens.parameterId} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5">
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] text-slate-500 font-bold">RANK #{sens.sensitivityRank}</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                        sens.direction === "POSITIVE" ? "bg-emerald-950 text-emerald-300 border-emerald-800" : "bg-slate-900 text-slate-400 border-slate-800"
                      }`}>
                        {sens.direction}
                      </span>
                    </div>
                    <div className="font-bold text-slate-200 truncate">{sens.parameterName}</div>
                    <div className="flex items-center justify-between text-[11px] pt-1">
                      <span className="text-slate-400">Elasticity:</span>
                      <span className="font-bold text-fuchsia-300">{sens.elasticityCoefficient}</span>
                    </div>
                    <div className="flex items-center justify-between text-[10px] text-slate-500">
                      <span>Output Delta:</span>
                      <span className={sens.outputDeltaPct >= 0 ? "text-emerald-400 font-bold" : "text-rose-400 font-bold"}>
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="space-y-3 font-mono text-xs">
                {coDesignReconciliations.map((rec) => (
                  <div key={rec.reconciliationId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-slate-200">Health Effect:</span>
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-emerald-950 text-emerald-300 border-emerald-800">
                        {rec.newHealthEffect}
                      </span>
                    </div>
                    <p className="text-[11px] text-slate-300 font-sans">{rec.evidenceDeltaSummary}</p>
                    <div className="text-[10px] text-slate-500 pt-1 border-t border-slate-900 font-sans">
                      <strong className="text-slate-400">Action:</strong> {rec.recommendedHumanAction}
                    </div>
                  </div>
                ))}
              </div>
                ...
                {coDesignOpportunities.map((opp) => (
                  <div key={opp.opportunityId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2 font-mono text-xs">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          opp.priority === "CRITICAL" ? "bg-rose-950 text-rose-300 border-rose-800" : "bg-amber-950 text-amber-300 border-amber-800"
                        }`}>
                          {opp.priority}
                        </span>
                        <span className="font-bold text-slate-200 text-xs font-sans">{opp.title}</span>
                      ...
                      <button
                        ...
                        disabled={opp.resolutionStatus === "VALIDATED"}
                        className="px-3 py-1.5 rounded-lg bg-fuchsia-600 hover:bg-fuchsia-500 disabled:opacity-50 text-white font-bold text-xs transition shrink-0"
                      >
                        {opp.resolutionStatus === "VALIDATED" ? "Validated in Phase 86" : "Create Research Validation Task"}
                      </button>
                    </div>
              ...
              <div className="space-y-3">
                {selectedCoDesignLineage.stages.map((stage) => (
                  <div key={stage.stage} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 flex items-start justify-between gap-4 font-mono text-xs">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-fuchsia-300">{stage.title}</span>
                        <span className="text-slate-500 text-[10px]">[{stage.stage}]</span>
                      </div>
                      <p className="text-slate-300 font-sans text-xs">{stage.output}</p>
                    </div>
                    <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-slate-900 text-slate-300 border-slate-800 shrink-0">
                      {stage.status}
                    </span>
                ...
                <table className="w-full text-left text-xs font-mono">
                  ...
                  <tbody className="divide-y divide-slate-800/60">
                    {coDesignHistory.map((ev) => (
                      <tr key={ev.auditId} className="hover:bg-slate-855/40">
                        <td className="p-2.5 text-slate-400">{new Date(ev.timestamp).toLocaleTimeString()}</td>
                        <td className="p-2.5 font-bold text-fuchsia-300">{ev.eventType}</td>
                        <td className="p-2.5 text-slate-300">{ev.targetId}</td>
                        <td className="p-2.5 text-slate-400">{ev.actor}</td>
                        <td className="p-2.5 text-slate-300 font-sans truncate max-w-xs">{ev.reason}</td>
                      </tr>
      ...
      {activeTab === "hypotheses" && (
        <div className="space-y-6">
          ...
          {/* Epistemic Boundary Principle Banner */}
          <div className="p-4 rounded-2xl bg-slate-950 border border-rose-800/60 text-rose-300 text-xs font-mono flex flex-col md:flex-row items-center justify-between gap-3 shadow-sm">
            <div className="flex items-center gap-2">
              <Compass className="w-4 h-4 text-rose-400 shrink-0" />
              <span className="font-bold">EPISTEMIC BOUNDARY:</span>
              <span className="text-slate-300">OBSERVED EVIDENCE &nbsp;≠&nbsp; PHYSICAL MEASUREMENT &nbsp;≠&nbsp; EXECUTION TRACE &nbsp;≠&nbsp; HARDWARE COUNTER &nbsp;≠&nbsp; SIMULATION &nbsp;≠&nbsp; FORECAST &nbsp;≠&nbsp; CORRELATION &nbsp;≠&nbsp; EMPIRICAL SYNTHESIS &nbsp;≠&nbsp; MICROARCHITECTURAL ATTRIBUTION &nbsp;≠&nbsp; CO-DESIGN SIMULATION &nbsp;≠&nbsp; HYPOTHESIS &nbsp;≠&nbsp; VALIDATION RESULT &nbsp;≠&nbsp; VERIFIED RESEARCH EVIDENCE</span>
            </div>
            <span className="px-2.5 py-1 rounded bg-rose-950/80 text-rose-300 border border-rose-700/80 text-[10px] uppercase font-bold shrink-0">
              Hypothesis Layer
            </span>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase border bg-rose-950 text-rose-300 border-rose-800">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-7 gap-3 font-mono text-xs">
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">HYPOTHESES</span>
                <span className="text-slate-200 font-bold block">{hypothesesList.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">COMPETING SETS</span>
                <span className="text-rose-400 font-bold block">{competingGroups.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">EVIDENCE ITEMS</span>
                <span className="text-cyan-400 font-bold block">{evidenceAttachments.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">PREDICTIONS</span>
                <span className="text-emerald-400 font-bold block">{hypothesisPredictions.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">VALIDATION TASKS</span>
                <span className="text-amber-400 font-bold block">{hypothesisValidationTasks.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">RECONCILIATIONS</span>
                <span className="text-indigo-400 font-bold block">{hypothesisReconciliations.length}</span>
              </div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-855">
                <span className="text-slate-500 block text-[10px]">OPPORTUNITIES</span>
                <span className="text-fuchsia-400 font-bold block">{hypothesisOpportunities.length}</span>
              </div>
            </div>
          </div>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            ...
            <div className="space-y-3">
              {hypothesesList.map((hyp) => (
                <div key={hyp.hypothesisId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-3 font-mono text-xs">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-900 pb-2">
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className="font-bold text-slate-200 text-sm font-sans">{hyp.title}</span>
                      <span className="px-2 py-0.5 rounded text-[10px] font-bold border bg-slate-900 text-slate-400 border-slate-800">
                        {hyp.domain}
                      </span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                    ...
                    <div className="flex items-center gap-2 shrink-0 text-[10px]">
                      <span className="px-2 py-0.5 rounded border bg-slate-900 text-slate-400 border-slate-800">
                        isCausallyEstablished: {hyp.causalStatus ? "true" : "false"}
                      </span>
                      <button
                        onClick={() => loadHypothesisLineage(hyp.hypothesisId)}
                        className="px-2.5 py-1 rounded bg-rose-950/60 hover:bg-rose-900/60 text-rose-300 border border-rose-800 font-bold transition"
                      >
                        Inspect Lineage
                      </button>
                    </div>
                  ...
                  <p className="text-slate-300 font-sans text-xs">{hyp.statement}</p>
                  ...
                  <div className="grid sm:grid-cols-3 gap-2 text-[11px] pt-1">
                    <div className="p-2.5 rounded-lg bg-slate-900/70 border border-slate-800 space-y-1">
                      ...
                      <span className="text-rose-300 font-bold">{hyp.currentConfidence}% ({hyp.confidenceBand})</span>
                    ...
                    <div className="p-2.5 rounded-lg bg-slate-900/70 border border-slate-800 space-y-1">
                      ...
                      <span className="text-amber-400 font-bold">{hyp.falsificationStrength}</span>
                    ...
                    <div className="p-2.5 rounded-lg bg-slate-900/70 border border-slate-800 space-y-1">
                      ...
                      <span className="text-slate-300 font-bold">{hyp.activeConfounders.length > 0 ? hyp.activeConfounders.join(", ") : "None Identified"}</span>
            ...
            {competingGroups[0] && (
              <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  ...
                  <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold border bg-rose-950 text-rose-300 border-rose-800">
                ...
                <div className="space-y-1 font-mono text-xs">
                  ...
                  <p className="text-slate-200 font-bold font-sans text-xs">{competingGroups[0].targetObservation}</p>
                </div>

                <div className="space-y-2.5 font-mono text-xs">
                  {competingGroups[0].hypotheses.map((hItem) => (
                    <div key={hItem.hypothesisId} className="p-3 rounded-xl bg-slate-950 border border-slate-855 space-y-1.5">
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-slate-200 truncate pr-2 font-sans">{hItem.title}</span>
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                ...
                <div className="p-3 rounded-xl bg-slate-950 border border-slate-855 text-xs font-mono space-y-1">
                  <span className="text-[10px] text-slate-500 uppercase font-bold">Diagnostic Differentiator:</span>
                  <p className="text-rose-300 font-sans text-xs">{competingGroups[0].primaryDiagnosticDifferentiator}</p>
                </div>
              </div>
            )}
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="space-y-3 font-mono text-xs">
                {hypothesisPredictions.map((pred) => (
                  <div key={pred.predictionId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2.5">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-slate-200">{pred.expectedMetric}</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                        pred.result === "MATCHED"
                          ? "bg-emerald-950 text-emerald-300 border-emerald-800"
                    ...
                    <div className="grid grid-cols-2 gap-2 text-[11px]">
                      <div>Expected: <strong className="text-emerald-400">{pred.expectedRange ? `${pred.expectedRange[0]} - ${pred.expectedRange[1]}` : "N/A"}</strong></div>
                      <div>Tolerance: <strong className="text-slate-300">±{pred.tolerancePercentage}%</strong></div>
                    </div>
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="space-y-3 font-mono text-xs">
                {hypothesisValidationTasks.map((task) => (
                  <div key={task.taskId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2.5">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                          task.priority === "CRITICAL" ? "bg-rose-950 text-rose-300 border-rose-800" : "bg-amber-950 text-amber-300 border-amber-800"
                        }`}>
                          {task.priority}
                        </span>
                        <span className="font-bold text-slate-200 font-sans text-xs">{task.objective}</span>
                      </div>
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-rose-600 hover:bg-rose-500 disabled:opacity-50 text-white font-bold text-xs transition shrink-0"
                      >
                        {task.validationStatus === "VALIDATION_PENDING" ? "Bridged to Phase 86" : "Bridge to Phase 86 Queue"}
                      </button>
                    </div>

                    <p className="text-slate-400 font-sans text-xs">{task.validationQuestion}</p>
            ...
            <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
              ...
              <div className="space-y-3 font-mono text-xs">
                {hypothesisReconciliations.map((rec) => (
                  <div key={rec.reconciliationId} className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="font-bold text-slate-200">Health Impact:</span>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                    ...
                    <p className="text-[11px] text-slate-300 font-sans">{rec.reasoning}</p>
                    <div className="text-[10px] text-slate-500 pt-1 border-t border-slate-900 font-sans">
                      <strong className="text-slate-400">Action:</strong> {rec.recommendedAction}
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-3">
                {selectedHypothesisLineage.stages.map((stage) => (
                  <div key={stage.stage} className="p-3.5 rounded-xl bg-slate-950 border border-slate-855 flex items-start justify-between gap-4 font-mono text-xs">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-rose-300">{stage.title}</span>
                        <span className="text-slate-500 text-[10px]">[{stage.stage}]</span>
                      </div>
                      <p className="text-slate-300 font-sans text-xs">{stage.output}</p>
                    </div>
          ...
          <div className="slate-card p-6 bg-slate-900/90 border-slate-800 space-y-4">
            <div className="grid sm:grid-cols-3 gap-4">
              {distPackage.targets.map((tgt) => (
                <div
                  key={tgt.platform}
                  className="p-4 rounded-xl bg-slate-950 border border-slate-855 space-y-3 flex flex-col justify-between"
                >
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        {tgt.platform === 'YOUTUBE_LONG_FORM' ? <Tv className="w-4 h-4 text-rose-400" /> :
                         tgt.platform === 'YOUTUBE_SHORTS' ? <Smartphone className="w-4 h-4 text-rose-400" /> :
                         <Radio className="w-4 h-4 text-purple-400" />}
                        <span className="text-xs font-bold text-slate-200">{tgt.platform}</span>
                      </div>
                      <span className={`px-2 py-0.5 rounded text-[10px] font-mono font-bold ${
                        tgt.status === 'APPROVED' ? 'bg-emerald-950 text-emerald-300 border border-emerald-800' :
                        tgt.status === 'SCHEDULED' ? 'bg-indigo-950 text-indigo-300 border border-indigo-800' :
                        tgt.status === 'BLOCKED' ? 'bg-rose-950 text-rose-300 border border-rose-800' :
                    ...
                    <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 space-y-1 font-mono text-[11px]">
                      <div className="flex justify-between text-slate-400">
                        ...
                        <span className="text-cyan-400 font-bold">{tgt.connectionState}</span>
                      </div>
                      <div className="flex justify-between text-slate-400">
                        <span>Readiness:</span>
                        <span className="text-slate-200 font-bold">{tgt.readinessScore}%</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      {tgt.status !== 'APPROVED' && tgt.status !== 'SCHEDULED' && !tgt.isBlocked && (
                        <button
                          ...
                          className="flex-1 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow-sm transition"
                        >
                          Approve Target
                        </button>
                      )}
                      ...
                      {tgt.status === 'APPROVED' && (
                        <button
                          ...
                          className="flex-1 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-sm transition"
                        >
                          Schedule Release
                        </button>
                      )}
                      ...
                      {tgt.status === 'SCHEDULED' && (
                        <button
                          ...
                          className="flex-1 py-1.5 rounded-lg bg-amber-950 hover:bg-amber-900 text-amber-300 text-xs font-mono font-bold border border-amber-800 transition"
                        >
                          Cancel Schedule
                        </button>
                      )}
